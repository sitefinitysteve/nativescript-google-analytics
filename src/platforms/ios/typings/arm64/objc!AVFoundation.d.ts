...
declare class AVAsset extends NSObject implements AVAsynchronousKeyValueLoading, NSCopying {
	...
	loadChapterMetadataGroupsBestMatchingPreferredLanguagesCompletionHandler(preferredLanguages: NSArray<string>, completionHandler: (p1: NSArray<AVTimedMetadataGroup>, p2: NSError) => void): void;

	loadChapterMetadataGroupsWithTitleLocaleContainingItemsWithCommonKeysCompletionHandler(locale: NSLocale, commonKeys: NSArray<string>, completionHandler: (p1: NSArray<AVTimedMetadataGroup>, p2: NSError) => void): void;
...
declare class AVMutableMovie extends AVMovie {
	...
	addMutableTracksCopyingSettingsFromTracksOptions(existingTracks: NSArray<AVAssetTrack>, options: NSDictionary<string, any>): NSArray<AVMutableMovieTrack>;
...
declare class AVPlayerInterstitialEvent extends NSObject {
	...
	readonly primaryItem: AVPlayerItem;

	readonly restrictions: AVPlayerInterstitialEventRestrictions;

	readonly resumptionOffset: CMTime;

	readonly templateItems: NSArray<AVPlayerItem>;

	readonly time: CMTime;

	readonly userDefinedAttributes: NSDictionary<any, any>;
}
...
declare class AVPlayerMediaSelectionCriteria extends NSObject {
	...
	constructor(o: { principalMediaCharacteristics: NSArray<string>; preferredLanguages: NSArray<string>; preferredMediaCharacteristics: NSArray<string>; });
	...
	initWithPrincipalMediaCharacteristicsPreferredLanguagesPreferredMediaCharacteristics(principalMediaCharacteristics: NSArray<string>, preferredLanguages: NSArray<string>, preferredMediaCharacteristics: NSArray<string>): this;
}
