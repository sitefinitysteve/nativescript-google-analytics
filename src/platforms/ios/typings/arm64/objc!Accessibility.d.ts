...
declare class AXCategoricalDataAxisDescriptor extends NSObject implements AXDataAxisDescriptor {
	...
	constructor(o: { attributedTitle: NSAttributedString; categoryOrder: NSArray<string>; });

	constructor(o: { title: string; categoryOrder: NSArray<string>; });

	copyWithZone(zone: interop.Pointer | interop.Reference<any>): any;

	initWithAttributedTitleCategoryOrder(attributedTitle: NSAttributedString, categoryOrder: NSArray<string>): this;

	initWithTitleCategoryOrder(title: string, categoryOrder: NSArray<string>): this;
}
...
declare class AXChartDescriptor extends NSObject implements NSCopying {
	...
	constructor(o: { attributedTitle: NSAttributedString; summary: string; xAxisDescriptor: AXDataAxisDescriptor; yAxisDescriptor: AXNumericDataAxisDescriptor; additionalAxes: NSArray<AXDataAxisDescriptor>; series: NSArray<AXDataSeriesDescriptor>; });

	constructor(o: { attributedTitle: NSAttributedString; summary: string; xAxisDescriptor: AXDataAxisDescriptor; yAxisDescriptor: AXNumericDataAxisDescriptor; series: NSArray<AXDataSeriesDescriptor>; });

	constructor(o: { title: string; summary: string; xAxisDescriptor: AXDataAxisDescriptor; yAxisDescriptor: AXNumericDataAxisDescriptor; additionalAxes: NSArray<AXDataAxisDescriptor>; series: NSArray<AXDataSeriesDescriptor>; });

	constructor(o: { title: string; summary: string; xAxisDescriptor: AXDataAxisDescriptor; yAxisDescriptor: AXNumericDataAxisDescriptor; series: NSArray<AXDataSeriesDescriptor>; });

	copyWithZone(zone: interop.Pointer | interop.Reference<any>): any;

	initWithAttributedTitleSummaryXAxisDescriptorYAxisDescriptorAdditionalAxesSeries(attributedTitle: NSAttributedString, summary: string, xAxis: AXDataAxisDescriptor, yAxis: AXNumericDataAxisDescriptor, additionalAxes: NSArray<AXDataAxisDescriptor>, series: NSArray<AXDataSeriesDescriptor>): this;

	initWithAttributedTitleSummaryXAxisDescriptorYAxisDescriptorSeries(attributedTitle: NSAttributedString, summary: string, xAxis: AXDataAxisDescriptor, yAxis: AXNumericDataAxisDescriptor, series: NSArray<AXDataSeriesDescriptor>): this;

	initWithTitleSummaryXAxisDescriptorYAxisDescriptorAdditionalAxesSeries(title: string, summary: string, xAxis: AXDataAxisDescriptor, yAxis: AXNumericDataAxisDescriptor, additionalAxes: NSArray<AXDataAxisDescriptor>, series: NSArray<AXDataSeriesDescriptor>): this;

	initWithTitleSummaryXAxisDescriptorYAxisDescriptorSeries(title: string, summary: string, xAxis: AXDataAxisDescriptor, yAxis: AXNumericDataAxisDescriptor, series: NSArray<AXDataSeriesDescriptor>): this;
}
...
declare class AXDataPoint extends NSObject implements NSCopying {
	...
	constructor(o: { x: AXDataPointValue; y: AXDataPointValue; additionalValues: NSArray<AXDataPointValue>; });

	constructor(o: { x: AXDataPointValue; y: AXDataPointValue; additionalValues: NSArray<AXDataPointValue>; label: string; });

	copyWithZone(zone: interop.Pointer | interop.Reference<any>): any;

	initWithXY(xValue: AXDataPointValue, yValue: AXDataPointValue): this;

	initWithXYAdditionalValues(xValue: AXDataPointValue, yValue: AXDataPointValue, additionalValues: NSArray<AXDataPointValue>): this;

	initWithXYAdditionalValuesLabel(xValue: AXDataPointValue, yValue: AXDataPointValue, additionalValues: NSArray<AXDataPointValue>, label: string): this;
}
...
declare class AXDataSeriesDescriptor extends NSObject implements NSCopying {
	...
	constructor(o: { attributedName: NSAttributedString; isContinuous: boolean; dataPoints: NSArray<AXDataPoint>; });

	constructor(o: { name: string; isContinuous: boolean; dataPoints: NSArray<AXDataPoint>; });

	copyWithZone(zone: interop.Pointer | interop.Reference<any>): any;

	initWithAttributedNameIsContinuousDataPoints(attributedName: NSAttributedString, isContinuous: boolean, dataPoints: NSArray<AXDataPoint>): this;

	initWithNameIsContinuousDataPoints(name: string, isContinuous: boolean, dataPoints: NSArray<AXDataPoint>): this;
}
...
declare class AXNumericDataAxisDescriptor extends NSObject implements AXDataAxisDescriptor {
	...
	constructor(o: { attributedTitle: NSAttributedString; lowerBound: number; upperBound: number; gridlinePositions: NSArray<number>; valueDescriptionProvider: (p1: number) => string; });

	constructor(o: { title: string; lowerBound: number; upperBound: number; gridlinePositions: NSArray<number>; valueDescriptionProvider: (p1: number) => string; });

	copyWithZone(zone: interop.Pointer | interop.Reference<any>): any;

	initWithAttributedTitleLowerBoundUpperBoundGridlinePositionsValueDescriptionProvider(attributedTitle: NSAttributedString, lowerbound: number, upperBound: number, gridlinePositions: NSArray<number>, valueDescriptionProvider: (p1: number) => string): this;

	initWithTitleLowerBoundUpperBoundGridlinePositionsValueDescriptionProvider(title: string, lowerbound: number, upperBound: number, gridlinePositions: NSArray<number>, valueDescriptionProvider: (p1: number) => string): this;
}
