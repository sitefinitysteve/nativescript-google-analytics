...
declare function AAEntryACLBlobAppendEntry(acl: interop.Pointer | interop.Reference<any>, ace: interop.Pointer | interop.Reference<AAAccessControlEntry>, qualifier_value: string, qualifier_size: number): number;

declare function AAEntryACLBlobApplyToPath(acl: interop.Pointer | interop.Reference<any>, dir: string, path: string, flags: number): number;
...
declare function AAEntryACLBlobCreateWithEncodedData(data: string, data_size: number): interop.Pointer | interop.Reference<any>;

declare function AAEntryACLBlobCreateWithPath(dir: string, path: string, flags: number): interop.Pointer | interop.Reference<any>;
...
declare function AAEntryACLBlobGetEntry(acl: interop.Pointer | interop.Reference<any>, i: number, ace: interop.Pointer | interop.Reference<AAAccessControlEntry>, qualifier_capacity: number, qualifier_value: string, qualifier_size: interop.Pointer | interop.Reference<number>): number;
...
declare function AAEntryACLBlobSetEntry(acl: interop.Pointer | interop.Reference<any>, i: number, ace: interop.Pointer | interop.Reference<AAAccessControlEntry>, qualifier_value: string, qualifier_size: number): number;
...
declare function AAEntryXATBlobAppendEntry(xat: interop.Pointer | interop.Reference<any>, key: string, data: string, data_size: number): number;

declare function AAEntryXATBlobApplyToPath(xat: interop.Pointer | interop.Reference<any>, dir: string, path: string, flags: number): number;
...
declare function AAEntryXATBlobCreateWithEncodedData(data: string, data_size: number): interop.Pointer | interop.Reference<any>;

declare function AAEntryXATBlobCreateWithPath(dir: string, path: string, flags: number): interop.Pointer | interop.Reference<any>;
...
declare function AAEntryXATBlobGetEntry(xat: interop.Pointer | interop.Reference<any>, i: number, key_capacity: number, key: string, key_length: interop.Pointer | interop.Reference<number>, data_capacity: number, data: string, data_size: interop.Pointer | interop.Reference<number>): number;
...
declare function AAEntryXATBlobSetEntry(xat: interop.Pointer | interop.Reference<any>, i: number, key: string, data: string, data_size: number): number;

declare function AAExtractArchiveOutputStreamOpen(dir: string, msg_data: interop.Pointer | interop.Reference<any>, msg_proc: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<any>, p2: number, p3: string, p4: interop.Pointer | interop.Reference<any>) => number>, flags: number, n_threads: number): interop.Pointer | interop.Reference<any>;
...
declare function AAFieldKeySetCreateWithString(s: string): interop.Pointer | interop.Reference<any>;
...
declare function AAFieldKeySetSerialize(key_set: interop.Pointer | interop.Reference<any>, capacity: number, s: string): number;
...
declare function AAFileStreamOpenWithPath(path: string, open_flags: number, open_mode: number): interop.Pointer | interop.Reference<any>;
...
declare const enum AAFlags {
	...
	A_FLAG_VERBOSITY_3 = 13835058055282163712
}
...
declare function AAHeaderCreateWithEncodedData(data_size: number, data: string): interop.Pointer | interop.Reference<any>;

declare function AAHeaderCreateWithPath(key_set: interop.Pointer | interop.Reference<any>, dir: string, path: string, flags: number): interop.Pointer | interop.Reference<any>;
...
declare function AAHeaderGetFieldHash(header: interop.Pointer | interop.Reference<any>, i: number, capacity: number, hash_function: interop.Pointer | interop.Reference<number>, value: string): number;

declare function AAHeaderGetFieldString(header: interop.Pointer | interop.Reference<any>, i: number, capacity: number, value: string, length: interop.Pointer | interop.Reference<number>): number;
...
declare function AAPathListCreateWithDirectoryContents(dir: string, path: string, msg_data: interop.Pointer | interop.Reference<any>, msg_proc: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<any>, p2: number, p3: string, p4: interop.Pointer | interop.Reference<any>) => number>, flags: number, n_threads: number): interop.Pointer | interop.Reference<any>;

declare function AAPathListCreateWithPath(dir: string, path: string): interop.Pointer | interop.Reference<any>;
...
declare function AAPathListNodeGetPath(path_list: interop.Pointer | interop.Reference<any>, node: number, path_capacity: number, path: string, path_length: interop.Pointer | interop.Reference<number>): number;
...
declare function AEAAuthDataAppendEntry(auth_data: interop.Pointer | interop.Reference<any>, key: string, data: string, data_size: number): number;
...
declare function AEAAuthDataGetEntry(auth_data: interop.Pointer | interop.Reference<any>, i: number, key_capacity: number, key: string, key_length: interop.Pointer | interop.Reference<number>, data_capacity: number, data: string, data_size: interop.Pointer | interop.Reference<number>): number;
...
declare function AEAAuthDataSetEntry(auth_data: interop.Pointer | interop.Reference<any>, i: number, key: string, data: string, data_size: number): number;
...
declare function AEAContextGetFieldBlob(context: interop.Pointer | interop.Reference<any>, field: number, representation: number, buf_capacity: number, buf: string, buf_size: interop.Pointer | interop.Reference<number>): number;

declare function AEAContextGetFieldUInt(context: interop.Pointer | interop.Reference<any>, field: number): number;

declare function AEAContextSetFieldBlob(context: interop.Pointer | interop.Reference<any>, field: number, representation: number, buf: string, buf_size: number): number;
