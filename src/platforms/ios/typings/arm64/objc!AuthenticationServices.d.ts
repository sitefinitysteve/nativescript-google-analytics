...
declare class ASAuthorizationAppleIDButton extends UIControl {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): ASAuthorizationAppleIDButton; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): ASAuthorizationAppleIDButton; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): ASAuthorizationAppleIDButton; // inherited from UIAppearance
...
declare class ASAuthorizationController extends NSObject {
	...
	constructor(o: { authorizationRequests: NSArray<ASAuthorizationRequest>; });

	initWithAuthorizationRequests(authorizationRequests: NSArray<ASAuthorizationRequest>): this;
...
declare class ASAuthorizationSecurityKeyPublicKeyCredentialDescriptor extends NSObject implements ASAuthorizationPublicKeyCredentialDescriptor {
	...
	constructor(o: { credentialID: NSData; transports: NSArray<string>; });
	...
	initWithCredentialIDTransports(credentialID: NSData, allowedTransports: NSArray<string>): this;
...
declare class ASCredentialIdentityStore extends NSObject {
	...
	removeCredentialIdentitiesCompletion(credentialIdentities: NSArray<ASPasswordCredentialIdentity>, completion: (p1: boolean, p2: NSError) => void): void;

	replaceCredentialIdentitiesWithIdentitiesCompletion(newCredentialIdentities: NSArray<ASPasswordCredentialIdentity>, completion: (p1: boolean, p2: NSError) => void): void;

	saveCredentialIdentitiesCompletion(credentialIdentities: NSArray<ASPasswordCredentialIdentity>, completion: (p1: boolean, p2: NSError) => void): void;
}
...
declare class ASCredentialProviderViewController extends UIViewController {
	...
	prepareCredentialListForServiceIdentifiers(serviceIdentifiers: NSArray<ASCredentialServiceIdentifier>): void;
