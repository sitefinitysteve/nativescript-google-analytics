...
declare class CPActionSheetTemplate extends CPTemplate {
	...
	constructor(o: { title: string; message: string; actions: NSArray<CPAlertAction>; });

	initWithTitleMessageActions(title: string, message: string, actions: NSArray<CPAlertAction>): this;
}
...
declare class CPAlertTemplate extends CPTemplate {
	...
	constructor(o: { titleVariants: NSArray<string>; actions: NSArray<CPAlertAction>; });

	initWithTitleVariantsActions(titleVariants: NSArray<string>, actions: NSArray<CPAlertAction>): this;
}
...
declare class CPDashboardButton extends NSObject implements NSSecureCoding {
	...
	constructor(o: { titleVariants: NSArray<string>; subtitleVariants: NSArray<string>; image: UIImage; handler: (p1: CPDashboardButton) => void; });

	encodeWithCoder(coder: NSCoder): void;

	initWithCoder(coder: NSCoder): this;

	initWithTitleVariantsSubtitleVariantsImageHandler(titleVariants: NSArray<string>, subtitleVariants: NSArray<string>, image: UIImage, handler: (p1: CPDashboardButton) => void): this;
}
...
declare class CPGridButton extends NSObject implements NSSecureCoding {
	...
	constructor(o: { titleVariants: NSArray<string>; image: UIImage; handler: (p1: CPGridButton) => void; });

	encodeWithCoder(coder: NSCoder): void;

	initWithCoder(coder: NSCoder): this;

	initWithTitleVariantsImageHandler(titleVariants: NSArray<string>, image: UIImage, handler: (p1: CPGridButton) => void): this;
}
...
declare class CPGridTemplate extends CPTemplate implements CPBarButtonProviding {
	...
	constructor(o: { title: string; gridButtons: NSArray<CPGridButton>; });

	class(): typeof NSObject;

	conformsToProtocol(aProtocol: any /* Protocol */): boolean;

	initWithTitleGridButtons(title: string, gridButtons: NSArray<CPGridButton>): this;
	...
	updateGridButtons(gridButtons: NSArray<CPGridButton>): void;
...
declare class CPInformationTemplate extends CPTemplate {
	...
	constructor(o: { title: string; layout: CPInformationTemplateLayout; items: NSArray<CPInformationItem>; actions: NSArray<CPTextButton>; });

	initWithTitleLayoutItemsActions(title: string, layout: CPInformationTemplateLayout, items: NSArray<CPInformationItem>, actions: NSArray<CPTextButton>): this;
}
...
declare class CPListImageRowItem extends NSObject implements CPSelectableListItem {
	...
	constructor(o: { text: string; images: NSArray<UIImage>; });

	class(): typeof NSObject;

	conformsToProtocol(aProtocol: any /* Protocol */): boolean;

	initWithTextImages(text: string, images: NSArray<UIImage>): this;
	...
	updateImages(gridImages: NSArray<UIImage>): void;
}
...
declare class CPListSection extends NSObject implements NSSecureCoding {
	...
	constructor(o: { items: NSArray<CPListTemplateItem>; });

	constructor(o: { items: NSArray<CPListTemplateItem>; header: string; headerSubtitle: string; headerImage: UIImage; headerButton: CPButton; sectionIndexTitle: string; });

	constructor(o: { items: NSArray<CPListTemplateItem>; header: string; sectionIndexTitle: string; });
	...
	initWithItems(items: NSArray<CPListTemplateItem>): this;

	initWithItemsHeaderHeaderSubtitleHeaderImageHeaderButtonSectionIndexTitle(items: NSArray<CPListTemplateItem>, header: string, headerSubtitle: string, headerImage: UIImage, headerButton: CPButton, sectionIndexTitle: string): this;

	initWithItemsHeaderSectionIndexTitle(items: NSArray<CPListTemplateItem>, header: string, sectionIndexTitle: string): this;
...
declare class CPListTemplate extends CPTemplate implements CPBarButtonProviding {
	...
	constructor(o: { title: string; sections: NSArray<CPListSection>; });

	constructor(o: { title: string; sections: NSArray<CPListSection>; assistantCellConfiguration: CPAssistantCellConfiguration; });
	...
	initWithTitleSections(title: string, sections: NSArray<CPListSection>): this;

	initWithTitleSectionsAssistantCellConfiguration(title: string, sections: NSArray<CPListSection>, assistantCellConfiguration: CPAssistantCellConfiguration): this;
	...
	updateSections(sections: NSArray<CPListSection>): void;
}
...
declare class CPMapTemplate extends CPTemplate implements CPBarButtonProviding {
	...
	showTripPreviewsSelectedTripTextConfiguration(tripPreviews: NSArray<CPTrip>, selectedTrip: CPTrip, textConfiguration: CPTripPreviewTextConfiguration): void;

	showTripPreviewsTextConfiguration(tripPreviews: NSArray<CPTrip>, textConfiguration: CPTripPreviewTextConfiguration): void;
...
declare class CPNavigationAlert extends NSObject implements NSSecureCoding {
	...
	constructor(o: { titleVariants: NSArray<string>; subtitleVariants: NSArray<string>; image: UIImage; primaryAction: CPAlertAction; secondaryAction: CPAlertAction; duration: number; });

	constructor(o: { titleVariants: NSArray<string>; subtitleVariants: NSArray<string>; imageSet: CPImageSet; primaryAction: CPAlertAction; secondaryAction: CPAlertAction; duration: number; });

	encodeWithCoder(coder: NSCoder): void;

	initWithCoder(coder: NSCoder): this;

	initWithTitleVariantsSubtitleVariantsImagePrimaryActionSecondaryActionDuration(titleVariants: NSArray<string>, subtitleVariants: NSArray<string>, image: UIImage, primaryAction: CPAlertAction, secondaryAction: CPAlertAction, duration: number): this;

	initWithTitleVariantsSubtitleVariantsImageSetPrimaryActionSecondaryActionDuration(titleVariants: NSArray<string>, subtitleVariants: NSArray<string>, imageSet: CPImageSet, primaryAction: CPAlertAction, secondaryAction: CPAlertAction, duration: number): this;

	updateTitleVariantsSubtitleVariants(newTitleVariants: NSArray<string>, newSubtitleVariants: NSArray<string>): void;
}
...
declare class CPNowPlayingTemplate extends CPTemplate {
	...
	updateNowPlayingButtons(nowPlayingButtons: NSArray<CPNowPlayingButton>): void;
}
...
declare class CPPointOfInterestTemplate extends CPTemplate {
	...
	constructor(o: { title: string; pointsOfInterest: NSArray<CPPointOfInterest>; selectedIndex: number; });

	initWithTitlePointsOfInterestSelectedIndex(title: string, pointsOfInterest: NSArray<CPPointOfInterest>, selectedIndex: number): this;

	setPointsOfInterestSelectedIndex(pointsOfInterest: NSArray<CPPointOfInterest>, selectedIndex: number): void;
}
...
declare class CPRouteChoice extends NSObject implements NSCopying, NSSecureCoding {
	...
	constructor(o: { summaryVariants: NSArray<string>; additionalInformationVariants: NSArray<string>; selectionSummaryVariants: NSArray<string>; });
	...
	initWithSummaryVariantsAdditionalInformationVariantsSelectionSummaryVariants(summaryVariants: NSArray<string>, additionalInformationVariants: NSArray<string>, selectionSummaryVariants: NSArray<string>): this;
}
...
declare class CPTabBarTemplate extends CPTemplate {
	...
	constructor(o: { templates: NSArray<CPTemplate>; });

	initWithTemplates(templates: NSArray<CPTemplate>): this;

	updateTemplates(newTemplates: NSArray<CPTemplate>): void;
}
...
declare class CPTrip extends NSObject implements NSSecureCoding {
	...
	constructor(o: { origin: MKMapItem; destination: MKMapItem; routeChoices: NSArray<CPRouteChoice>; });

	encodeWithCoder(coder: NSCoder): void;

	initWithCoder(coder: NSCoder): this;

	initWithOriginDestinationRouteChoices(origin: MKMapItem, destination: MKMapItem, routeChoices: NSArray<CPRouteChoice>): this;
}
...
declare class CPVoiceControlState extends NSObject implements NSSecureCoding {
	...
	constructor(o: { identifier: string; titleVariants: NSArray<string>; image: UIImage; repeats: boolean; });

	encodeWithCoder(coder: NSCoder): void;

	initWithCoder(coder: NSCoder): this;

	initWithIdentifierTitleVariantsImageRepeats(identifier: string, titleVariants: NSArray<string>, image: UIImage, repeats: boolean): this;
}
...
declare class CPVoiceControlTemplate extends CPTemplate {
	...
	constructor(o: { voiceControlStates: NSArray<CPVoiceControlState>; });

	activateVoiceControlStateWithIdentifier(identifier: string): void;

	initWithVoiceControlStates(voiceControlStates: NSArray<CPVoiceControlState>): this;
}
...
declare class CPWindow extends UIWindow {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): CPWindow; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): CPWindow; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): CPWindow; // inherited from UIAppearance
