...
declare class CLSContext extends CLSObject {
	...
	descendantMatchingIdentifierPathCompletion(identifierPath: NSArray<string>, completion: (p1: CLSContext, p2: NSError) => void): void;
...
declare class CLSDataStore extends NSObject {
	...
	completeAllAssignedActivitiesMatching(contextPath: NSArray<string>): void;

	contextsMatchingIdentifierPathCompletion(identifierPath: NSArray<string>, completion: (p1: NSArray<CLSContext>, p2: NSError) => void): void;
...
interface CLSDataStoreDelegate extends NSObjectProtocol {
	...
	createContextForIdentifierParentContextParentIdentifierPath(identifier: string, parentContext: CLSContext, parentIdentifierPath: NSArray<string>): CLSContext;
}
