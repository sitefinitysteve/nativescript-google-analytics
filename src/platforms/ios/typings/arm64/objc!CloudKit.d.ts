...
declare class CKFetchRecordZoneChangesOperation extends CKDatabaseOperation {
	...
	constructor(o: { recordZoneIDs: NSArray<CKRecordZoneID>; configurationsByRecordZoneID: NSDictionary<CKRecordZoneID, CKFetchRecordZoneChangesConfiguration>; });
	...
	initWithRecordZoneIDsConfigurationsByRecordZoneID(recordZoneIDs: NSArray<CKRecordZoneID>, configurationsByRecordZoneID: NSDictionary<CKRecordZoneID, CKFetchRecordZoneChangesConfiguration>): this;
