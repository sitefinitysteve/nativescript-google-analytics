...
declare class NSBatchInsertRequest extends NSPersistentStoreRequest {
	...
	static batchInsertRequestWithEntityNameObjects(entityName: string, dictionaries: NSArray<NSDictionary<string, any>>): NSBatchInsertRequest;
	...
	constructor(o: { entityName: string; objects: NSArray<NSDictionary<string, any>>; });

	constructor(o: { entity: NSEntityDescription; objects: NSArray<NSDictionary<string, any>>; });
	...
	initWithEntityNameObjects(entityName: string, dictionaries: NSArray<NSDictionary<string, any>>): this;

	initWithEntityObjects(entity: NSEntityDescription, dictionaries: NSArray<NSDictionary<string, any>>): this;
}
...
declare class NSPersistentCloudKitContainer extends NSPersistentContainer {
	...
	recordIDsForManagedObjectIDs(managedObjectIDs: NSArray<NSManagedObjectID>): NSDictionary<NSManagedObjectID, CKRecordID>;

	recordsForManagedObjectIDs(managedObjectIDs: NSArray<NSManagedObjectID>): NSDictionary<NSManagedObjectID, CKRecord>;
}
...
declare class NSPersistentStoreCoordinator extends NSObject implements NSLocking {
	...
	currentPersistentHistoryTokenFromStores(stores: NSArray<any>): NSPersistentHistoryToken;
