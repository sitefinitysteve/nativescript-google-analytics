...
declare class CHHapticEvent extends NSObject {
	...
	constructor(o: { audioResourceID: number; parameters: NSArray<CHHapticEventParameter>; relativeTime: number; });

	constructor(o: { audioResourceID: number; parameters: NSArray<CHHapticEventParameter>; relativeTime: number; duration: number; });

	constructor(o: { eventType: string; parameters: NSArray<CHHapticEventParameter>; relativeTime: number; });

	constructor(o: { eventType: string; parameters: NSArray<CHHapticEventParameter>; relativeTime: number; duration: number; });

	initWithAudioResourceIDParametersRelativeTime(resID: number, eventParams: NSArray<CHHapticEventParameter>, time: number): this;

	initWithAudioResourceIDParametersRelativeTimeDuration(resID: number, eventParams: NSArray<CHHapticEventParameter>, time: number, duration: number): this;

	initWithEventTypeParametersRelativeTime(type: string, eventParams: NSArray<CHHapticEventParameter>, time: number): this;

	initWithEventTypeParametersRelativeTimeDuration(type: string, eventParams: NSArray<CHHapticEventParameter>, time: number, duration: number): this;
}
...
declare class CHHapticParameterCurve extends NSObject {
	...
	constructor(o: { parameterID: string; controlPoints: NSArray<CHHapticParameterCurveControlPoint>; relativeTime: number; });

	initWithParameterIDControlPointsRelativeTime(parameterID: string, controlPoints: NSArray<CHHapticParameterCurveControlPoint>, relativeTime: number): this;
}
...
declare class CHHapticPattern extends NSObject {
	...
	constructor(o: { events: NSArray<CHHapticEvent>; parameterCurves: NSArray<CHHapticParameterCurve>; });

	constructor(o: { events: NSArray<CHHapticEvent>; parameters: NSArray<CHHapticDynamicParameter>; });

	exportDictionaryAndReturnError(): NSDictionary<string, any>;

	initWithDictionaryError(patternDict: NSDictionary<string, any>): this;

	initWithEventsParameterCurvesError(events: NSArray<CHHapticEvent>, parameterCurves: NSArray<CHHapticParameterCurve>): this;

	initWithEventsParametersError(events: NSArray<CHHapticEvent>, parameters: NSArray<CHHapticDynamicParameter>): this;
}
...
interface CHHapticPatternPlayer extends NSObjectProtocol {
	...
	sendParametersAtTimeError(parameters: NSArray<CHHapticDynamicParameter>, time: number): boolean;
