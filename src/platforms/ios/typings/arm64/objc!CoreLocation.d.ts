...
interface CLLocationManagerDelegate extends NSObjectProtocol {
	...
	locationManagerDidRangeBeaconsSatisfyingConstraint?(manager: CLLocationManager, beacons: NSArray<CLBeacon>, beaconConstraint: CLBeaconIdentityConstraint): void;
