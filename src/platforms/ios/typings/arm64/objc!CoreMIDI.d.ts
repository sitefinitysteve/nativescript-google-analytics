...
declare class MIDICIProfileState extends NSObject implements NSSecureCoding {
	...
	constructor(o: { channel: number; enabledProfiles: NSArray<MIDICIProfile>; disabledProfiles: NSArray<MIDICIProfile>; });

	constructor(o: { coder: NSCoder; }); // inherited from NSCoding

	constructor(o: { enabledProfiles: NSArray<MIDICIProfile>; disabledProfiles: NSArray<MIDICIProfile>; });

	encodeWithCoder(coder: NSCoder): void;

	initWithChannelEnabledProfilesDisabledProfiles(midiChannelNum: number, enabled: NSArray<MIDICIProfile>, disabled: NSArray<MIDICIProfile>): this;

	initWithCoder(coder: NSCoder): this;

	initWithEnabledProfilesDisabledProfiles(enabled: NSArray<MIDICIProfile>, disabled: NSArray<MIDICIProfile>): this;
}
...
declare class MIDICIResponder extends NSObject {
	...
	constructor(o: { deviceInfo: MIDICIDeviceInfo; profileDelegate: MIDICIProfileResponderDelegate; profileStates: NSArray<MIDICIProfileState>; supportProperties: boolean; });

	initWithDeviceInfoProfileDelegateProfileStatesSupportProperties(deviceInfo: MIDICIDeviceInfo, delegate: MIDICIProfileResponderDelegate, profileList: NSArray<MIDICIProfileState>, propertiesSupported: boolean): this;
