...
interface NFCFeliCaTag extends NFCNDEFTag, NFCTag {
	...
	readWithoutEncryptionWithServiceCodeListBlockListCompletionHandler(serviceCodeList: NSArray<NSData>, blockList: NSArray<NSData>, completionHandler: (p1: number, p2: number, p3: NSArray<NSData>, p4: NSError) => void): void;

	requestResponseWithCompletionHandler(completionHandler: (p1: number, p2: NSError) => void): void;

	requestServiceV2WithNodeCodeListCompletionHandler(nodeCodeList: NSArray<NSData>, completionHandler: (p1: number, p2: number, p3: NFCFeliCaEncryptionId, p4: NSArray<NSData>, p5: NSArray<NSData>, p6: NSError) => void): void;

	requestServiceWithNodeCodeListCompletionHandler(nodeCodeList: NSArray<NSData>, completionHandler: (p1: NSArray<NSData>, p2: NSError) => void): void;
	...
	writeWithoutEncryptionWithServiceCodeListBlockListBlockDataCompletionHandler(serviceCodeList: NSArray<NSData>, blockList: NSArray<NSData>, blockData: NSArray<NSData>, completionHandler: (p1: number, p2: number, p3: NSError) => void): void;
}
...
interface NFCISO15693Tag extends NFCNDEFTag, NFCTag {
	...
	extendedWriteMultipleBlocksWithRequestFlagsBlockRangeDataBlocksCompletionHandler(flags: NFCISO15693RequestFlag, blockRange: NSRange, dataBlocks: NSArray<NSData>, completionHandler: (p1: NSError) => void): void;
	...
	writeMultipleBlocksWithRequestFlagsBlockRangeDataBlocksCompletionHandler(flags: NFCISO15693RequestFlag, blockRange: NSRange, dataBlocks: NSArray<NSData>, completionHandler: (p1: NSError) => void): void;
...
declare class NFCNDEFMessage extends NSObject implements NSSecureCoding {
	...
	constructor(o: { NDEFRecords: NSArray<NFCNDEFPayload>; });

	encodeWithCoder(coder: NSCoder): void;

	initWithCoder(coder: NSCoder): this;

	initWithNDEFRecords(records: NSArray<NFCNDEFPayload>): this;
}
...
interface NFCNDEFReaderSessionDelegate extends NSObjectProtocol {
	...
	readerSessionDidDetectTags?(session: NFCNDEFReaderSession, tags: NSArray<NFCNDEFTag>): void;
...
interface NFCTagReaderSessionDelegate extends NSObjectProtocol {
	...
	tagReaderSessionDidDetectTags?(session: NFCTagReaderSession, tags: NSArray<NFCTag>): void;
...
declare class NFCVASReaderSession extends NFCReaderSession {
	...
	constructor(o: { VASCommandConfigurations: NSArray<NFCVASCommandConfiguration>; delegate: NFCVASReaderSessionDelegate; queue: NSObject; });

	initWithVASCommandConfigurationsDelegateQueue(commandConfigurations: NSArray<NFCVASCommandConfiguration>, delegate: NFCVASReaderSessionDelegate, queue: NSObject): this;
}
...
interface NFCVASReaderSessionDelegate extends NSObjectProtocol {
	...
	readerSessionDidReceiveVASResponses(session: NFCVASReaderSession, responses: NSArray<NFCVASResponse>): void;
}
