...
declare class TKBERTLVRecord extends TKTLVRecord {
	...
	constructor(o: { tag: number; records: NSArray<TKTLVRecord>; });

	constructor(o: { tag: number; value: NSData; });

	initWithTagRecords(tag: number, records: NSArray<TKTLVRecord>): this;
...
declare class TKTokenKeychainContents extends NSObject {
	...
	fillWithItems(items: NSArray<TKTokenKeychainItem>): void;
