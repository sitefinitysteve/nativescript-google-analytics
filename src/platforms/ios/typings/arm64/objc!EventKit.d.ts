...
declare class EKVirtualConferenceDescriptor extends NSObject {
	...
	constructor(o: { title: string; URLDescriptors: NSArray<EKVirtualConferenceURLDescriptor>; conferenceDetails: string; });

	initWithTitleURLDescriptorsConferenceDetails(title: string, URLDescriptors: NSArray<EKVirtualConferenceURLDescriptor>, conferenceDetails: string): this;
}
