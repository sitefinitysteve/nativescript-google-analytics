...
declare class ENManager extends NSObject {
	...
	detectExposuresWithConfigurationDiagnosisKeyURLsCompletionHandler(configuration: ENExposureConfiguration, diagnosisKeyURLs: NSArray<NSURL>, completionHandler: (p1: ENExposureDetectionSummary, p2: NSError) => void): NSProgress;
