...
declare class NSArray<ObjectType> extends NSObject implements CKRecordValue, NSCopying, NSFastEnumeration, NSMutableCopying, NSSecureCoding {
	...
	differenceFromArray(other: NSArray<ObjectType>): NSOrderedCollectionDifference<ObjectType>;

	differenceFromArrayWithOptions(other: NSArray<ObjectType>, options: NSOrderedCollectionDifferenceCalculationOptions): NSOrderedCollectionDifference<ObjectType>;

	differenceFromArrayWithOptionsUsingEquivalenceTest(other: NSArray<ObjectType>, options: NSOrderedCollectionDifferenceCalculationOptions, block: (p1: ObjectType, p2: ObjectType) => boolean): NSOrderedCollectionDifference<ObjectType>;
...
declare class NSCoder extends NSObject {
	...
	decodeValueOfObjCTypeAtSize(type: string, data: interop.Pointer | interop.Reference<any>, size: number): void;
	...
	encodeBytesLengthForKey(bytes: string, length: number, key: string): void;
...
declare class NSListFormatter extends NSFormatter {
	...
	static localizedStringByJoiningStrings(strings: NSArray<string>): string;
	...
	stringFromItems(items: NSArray<any>): string;
}
...
declare class NSOrderedCollectionDifference<ObjectType> extends NSObject implements NSFastEnumeration {
	...
	constructor(o: { changes: NSArray<NSOrderedCollectionChange<ObjectType>>; });

	constructor(o: { insertIndexes: NSIndexSet; insertedObjects: NSArray<ObjectType>; removeIndexes: NSIndexSet; removedObjects: NSArray<ObjectType>; });

	constructor(o: { insertIndexes: NSIndexSet; insertedObjects: NSArray<ObjectType>; removeIndexes: NSIndexSet; removedObjects: NSArray<ObjectType>; additionalChanges: NSArray<NSOrderedCollectionChange<ObjectType>>; });
	...
	initWithChanges(changes: NSArray<NSOrderedCollectionChange<ObjectType>>): this;

	initWithInsertIndexesInsertedObjectsRemoveIndexesRemovedObjects(inserts: NSIndexSet, insertedObjects: NSArray<ObjectType>, removes: NSIndexSet, removedObjects: NSArray<ObjectType>): this;

	initWithInsertIndexesInsertedObjectsRemoveIndexesRemovedObjectsAdditionalChanges(inserts: NSIndexSet, insertedObjects: NSArray<ObjectType>, removes: NSIndexSet, removedObjects: NSArray<ObjectType>, changes: NSArray<NSOrderedCollectionChange<ObjectType>>): this;
...
declare class NSPresentationIntent extends NSObject implements NSCopying, NSSecureCoding {
	...
	static tableIntentWithIdentityColumnCountAlignmentsNestedInsideIntent(identity: number, columnCount: number, alignments: NSArray<number>, parent: NSPresentationIntent): NSPresentationIntent;
...
declare class NSURLSession extends NSObject {
	...
	webSocketTaskWithURLProtocols(url: NSURL, protocols: NSArray<string>): NSURLSessionWebSocketTask;
}
...
declare class NSUserActivity extends NSObject implements NSItemProviderReading, NSItemProviderWriting {
	...
	static deleteSavedUserActivitiesWithPersistentIdentifiersCompletionHandler(persistentIdentifiers: NSArray<string>, handler: () => void): void;
