...
declare class GKLeaderboard extends NSObject {
	...
	static loadLeaderboardsWithIDsCompletionHandler(leaderboardIDs: NSArray<string>, completionHandler: (p1: NSArray<GKLeaderboard>, p2: NSError) => void): void;
	...
	static submitScoreContextPlayerLeaderboardIDsCompletionHandler(score: number, context: number, player: GKPlayer, leaderboardIDs: NSArray<string>, completionHandler: (p1: NSError) => void): void;
	...
	loadEntriesForPlayersTimeScopeCompletionHandler(players: NSArray<GKPlayer>, timeScope: GKLeaderboardTimeScope, completionHandler: (p1: GKLeaderboardEntry) => void): void;
...
declare class GKLocalPlayer extends GKPlayer implements GKSavedGameListener {
	...
	loadFriendsWithIdentifiersCompletionHandler(identifiers: NSArray<string>, completionHandler: (p1: NSArray<GKPlayer>, p2: NSError) => void): void;
...
declare class GKScore extends NSObject implements NSCoding, NSSecureCoding {
	...
	static reportLeaderboardScoresWithEligibleChallengesWithCompletionHandler(scores: NSArray<GKLeaderboardScore>, challenges: NSArray<GKChallenge>, completionHandler: (p1: NSError) => void): void;
...
declare class GKTurnBasedMatch extends NSObject {
	...
	endMatchInTurnWithMatchDataLeaderboardScoresAchievementsCompletionHandler(matchData: NSData, scores: NSArray<GKLeaderboardScore>, achievements: NSArray<any>, completionHandler: (p1: NSError) => void): void;
