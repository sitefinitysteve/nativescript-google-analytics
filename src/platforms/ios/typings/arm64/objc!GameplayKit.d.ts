...
declare class GKGraphNode2D extends GKGraphNode {
	...
	static nodeWithPoint(point ): GKGraphNode2D;

	position;

	constructor(o: { point; });

	initWithPoint(point ): this;
}
...
declare class GKGraphNode3D extends GKGraphNode {
	...
	static nodeWithPoint(point ): GKGraphNode3D;
...
declare class GKGridGraph<NodeType> extends GKGraph {
	...
	static graphFromGridStartingAtWidthHeightDiagonalsAllowed<NodeType>(position, width: number, height: number, diagonalsAllowed: boolean): GKGridGraph<NodeType>;

	static graphFromGridStartingAtWidthHeightDiagonalsAllowedNodeClass<NodeType>(position, width: number, height: number, diagonalsAllowed: boolean, nodeClass: typeof NSObject): GKGridGraph<NodeType>;
	...
	constructor(o: { fromGridStartingAt; width: number; height: number; diagonalsAllowed: boolean; });

	constructor(o: { fromGridStartingAt; width: number; height: number; diagonalsAllowed: boolean; nodeClass: typeof NSObject; });

	classForGenericArgumentAtIndex(index: number): typeof NSObject;

	connectNodeToAdjacentNodes(node: GKGridGraphNode): void;

	initFromGridStartingAtWidthHeightDiagonalsAllowed(position, width: number, height: number, diagonalsAllowed: boolean): this;

	initFromGridStartingAtWidthHeightDiagonalsAllowedNodeClass(position, width: number, height: number, diagonalsAllowed: boolean, nodeClass: typeof NSObject): this;

	nodeAtGridPosition(position ): NodeType;
}
...
declare class GKGridGraphNode extends GKGraphNode {
	...
	static nodeWithGridPosition(gridPosition ): GKGridGraphNode;

	readonly gridPosition;

	constructor(o: { gridPosition; });

	initWithGridPosition(gridPosition ): this;
}
...
declare class GKMeshGraph<NodeType> extends GKGraph {
	...
	static graphWithBufferRadiusMinCoordinateMaxCoordinate<NodeType>(bufferRadius: number, min, max ): GKMeshGraph<NodeType>;

	static graphWithBufferRadiusMinCoordinateMaxCoordinateNodeClass<NodeType>(bufferRadius: number, min, max, nodeClass: typeof NSObject): GKMeshGraph<NodeType>;
	...
	constructor(o: { bufferRadius: number; minCoordinate; maxCoordinate; });

	constructor(o: { bufferRadius: number; minCoordinate; maxCoordinate; nodeClass: typeof NSObject; });
	...
	initWithBufferRadiusMinCoordinateMaxCoordinate(bufferRadius: number, min, max ): this;

	initWithBufferRadiusMinCoordinateMaxCoordinateNodeClass(bufferRadius: number, min, max, nodeClass: typeof NSObject): this;
...
declare class GKNoise extends NSObject {
	...
	rotateBy(radians ): void;

	scaleBy(factor ): void;

	valueAtPosition(position ): number;
}
...
declare class GKNoiseMap extends NSObject {
	...
	static noiseMapWithNoiseSizeOriginSampleCountSeamless(noise: GKNoise, size, origin, sampleCount, seamless: boolean): GKNoiseMap;
	...
	constructor(o: { noise: GKNoise; size; origin; sampleCount; seamless: boolean; });

	initWithNoise(noise: GKNoise): this;

	initWithNoiseSizeOriginSampleCountSeamless(noise: GKNoise, size, origin, sampleCount, seamless: boolean): this;

	interpolatedValueAtPosition(position ): number;

	setValueAtPosition(value: number, position ): void;
...
declare class GKOctree<ElementType> extends NSObject {
	...
	addElementWithPoint(element: ElementType, point ): GKOctreeNode;

	elementsAtPoint(point ): NSArray<ElementType>;
...
declare class GKPath extends NSObject {
	...
	static pathWithFloat3PointsCountRadiusCyclical(points: interop.Pointer | interop.Reference<>, count: number, radius: number, cyclical: boolean): GKPath;

	static pathWithGraphNodesRadius(graphNodes: NSArray<GKGraphNode>, radius: number): GKPath;

	static pathWithPointsCountRadiusCyclical(points: interop.Pointer | interop.Reference<>, count: number, radius: number, cyclical: boolean): GKPath;
	...
	constructor(o: { float3Points: interop.Pointer | interop.Reference<>; count: number; radius: number; cyclical: boolean; });

	constructor(o: { graphNodes: NSArray<GKGraphNode>; radius: number; });

	constructor(o: { points: interop.Pointer | interop.Reference<>; count: number; radius: number; cyclical: boolean; });

	float2AtIndex(index: number);

	float3AtIndex(index: number);

	initWithFloat3PointsCountRadiusCyclical(points: interop.Pointer | interop.Reference<>, count: number, radius: number, cyclical: boolean): this;

	initWithGraphNodesRadius(graphNodes: NSArray<GKGraphNode>, radius: number): this;

	initWithPointsCountRadiusCyclical(points: interop.Pointer | interop.Reference<>, count: number, radius: number, cyclical: boolean): this;

	pointAtIndex(index: number);
}
...
declare class GKPolygonObstacle extends GKObstacle implements NSSecureCoding {
	...
	static obstacleWithPointsCount(points: interop.Pointer | interop.Reference<>, numPoints: number): GKPolygonObstacle;
	...
	constructor(o: { points: interop.Pointer | interop.Reference<>; count: number; });

	encodeWithCoder(coder: NSCoder): void;

	initWithCoder(coder: NSCoder): this;

	initWithPointsCount(points: interop.Pointer | interop.Reference<>, numPoints: number): this;

	vertexAtIndex(index: number);
}
...
declare class GKQuadtree<ElementType> extends NSObject {
	...
	addElementWithPoint(element: ElementType, point ): GKQuadtreeNode;
...
declare class GKRTree<ElementType> extends NSObject {
	...
	addElementBoundingRectMinBoundingRectMaxSplitStrategy(element: ElementType, boundingRectMin, boundingRectMax, splitStrategy: GKRTreeSplitStrategy): void;

	elementsInBoundingRectMinRectMax(rectMin, rectMax ): NSArray<ElementType>;

	initWithMaxNumberOfChildren(maxNumberOfChildren: number): this;

	removeElementBoundingRectMinBoundingRectMax(element: ElementType, boundingRectMin, boundingRectMax ): void;
}
