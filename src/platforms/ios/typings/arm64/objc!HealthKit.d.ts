...
declare class HKAnchoredObjectQuery extends HKQuery {
	...
	constructor(o: { queryDescriptors: NSArray<HKQueryDescriptor>; anchor: HKQueryAnchor; limit: number; resultsHandler: (p1: HKAnchoredObjectQuery, p2: NSArray<HKSample>, p3: NSArray<HKDeletedObject>, p4: HKQueryAnchor, p5: NSError) => void; });
	...
	initWithQueryDescriptorsAnchorLimitResultsHandler(queryDescriptors: NSArray<HKQueryDescriptor>, anchor: HKQueryAnchor, limit: number, handler: (p1: HKAnchoredObjectQuery, p2: NSArray<HKSample>, p3: NSArray<HKDeletedObject>, p4: HKQueryAnchor, p5: NSError) => void): this;
...
declare class HKAudiogramSample extends HKSample {
	...
	static audiogramSampleWithSensitivityPointsStartDateEndDateMetadata(sensitivityPoints: NSArray<HKAudiogramSensitivityPoint>, startDate: Date, endDate: Date, metadata: NSDictionary<string, any>): HKAudiogramSample;
...
declare class HKObserverQuery extends HKQuery {
	...
	constructor(o: { queryDescriptors: NSArray<HKQueryDescriptor>; updateHandler: (p1: HKObserverQuery, p2: NSSet<HKSampleType>, p3: () => void, p4: NSError) => void; });

	constructor(o: { sampleType: HKSampleType; predicate: NSPredicate; updateHandler: (p1: HKObserverQuery, p2: () => void, p3: NSError) => void; });

	initWithQueryDescriptorsUpdateHandler(queryDescriptors: NSArray<HKQueryDescriptor>, updateHandler: (p1: HKObserverQuery, p2: NSSet<HKSampleType>, p3: () => void, p4: NSError) => void): this;
...
declare class HKSampleQuery extends HKQuery {
	...
	constructor(o: { queryDescriptors: NSArray<HKQueryDescriptor>; limit: number; resultsHandler: (p1: HKSampleQuery, p2: NSArray<HKSample>, p3: NSError) => void; });

	constructor(o: { queryDescriptors: NSArray<HKQueryDescriptor>; limit: number; sortDescriptors: NSArray<NSSortDescriptor>; resultsHandler: (p1: HKSampleQuery, p2: NSArray<HKSample>, p3: NSError) => void; });
	...
	initWithQueryDescriptorsLimitResultsHandler(queryDescriptors: NSArray<HKQueryDescriptor>, limit: number, resultsHandler: (p1: HKSampleQuery, p2: NSArray<HKSample>, p3: NSError) => void): this;

	initWithQueryDescriptorsLimitSortDescriptorsResultsHandler(queryDescriptors: NSArray<HKQueryDescriptor>, limit: number, sortDescriptors: NSArray<NSSortDescriptor>, resultsHandler: (p1: HKSampleQuery, p2: NSArray<HKSample>, p3: NSError) => void): this;
...
declare class HKVerifiableClinicalRecordQuery extends HKQuery {
	...
	constructor(o: { recordTypes: NSArray<string>; predicate: NSPredicate; resultsHandler: (p1: HKVerifiableClinicalRecordQuery, p2: NSArray<HKVerifiableClinicalRecord>, p3: NSError) => void; });

	initWithRecordTypesPredicateResultsHandler(recordTypes: NSArray<string>, predicate: NSPredicate, resultsHandler: (p1: HKVerifiableClinicalRecordQuery, p2: NSArray<HKVerifiableClinicalRecord>, p3: NSError) => void): this;
}
...
declare class HKWorkoutBuilder extends NSObject {
	...
	addSamplesCompletion(samples: NSArray<HKSample>, completion: (p1: boolean, p2: NSError) => void): void;

	addWorkoutEventsCompletion(workoutEvents: NSArray<HKWorkoutEvent>, completion: (p1: boolean, p2: NSError) => void): void;
