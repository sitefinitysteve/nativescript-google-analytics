...
declare class HMMutableCharacteristicEvent<TriggerValueType> extends HMCharacteristicEvent<NSObject> {

	static alloc<TriggerValueType>(): HMMutableCharacteristicEvent<TriggerValueType>; // inherited from NSObject

	static new<TriggerValueType>(): HMMutableCharacteristicEvent<TriggerValueType>; // inherited from NSObject
