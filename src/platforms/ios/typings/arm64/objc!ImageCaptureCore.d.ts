...
declare class ICCameraDevice extends ICDevice {
	...
	requestDeleteFiles(files: NSArray<ICCameraItem>): void;

	requestDeleteFilesDeleteFailedCompletion(files: NSArray<ICCameraItem>, deleteFailed: (p1: NSDictionary<string, ICCameraItem>) => void, completion: (p1: NSDictionary<string, NSArray<ICCameraItem>>, p2: NSError) => void): NSProgress;
...
interface ICCameraDeviceDelegate extends ICDeviceDelegate {
	...
	cameraDeviceDidAddItems(camera: ICCameraDevice, items: NSArray<ICCameraItem>): void;
	...
	cameraDeviceDidRemoveItems(camera: ICCameraDevice, items: NSArray<ICCameraItem>): void;

	cameraDeviceDidRenameItems(camera: ICCameraDevice, items: NSArray<ICCameraItem>): void;
