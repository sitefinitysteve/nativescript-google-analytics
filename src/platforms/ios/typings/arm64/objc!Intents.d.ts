...
declare class INAddMediaIntent extends INIntent {
	...
	constructor(o: { mediaItems: NSArray<INMediaItem>; mediaSearch: INMediaSearch; mediaDestination: INMediaDestination; });

	initWithMediaItemsMediaSearchMediaDestination(mediaItems: NSArray<INMediaItem>, mediaSearch: INMediaSearch, mediaDestination: INMediaDestination): this;
}
...
declare class INAddMediaMediaDestinationResolutionResult extends INMediaDestinationResolutionResult {
	...
	static disambiguationWithMediaDestinationsToDisambiguate(mediaDestinationsToDisambiguate: NSArray<INMediaDestination>): INAddMediaMediaDestinationResolutionResult; // inherited from INMediaDestinationResolutionResult
...
declare class INAddMediaMediaItemResolutionResult extends INMediaItemResolutionResult {
	...
	static disambiguationWithMediaItemsToDisambiguate(mediaItemsToDisambiguate: NSArray<INMediaItem>): INAddMediaMediaItemResolutionResult; // inherited from INMediaItemResolutionResult
...
declare class INAddTasksIntent extends INIntent {
	...
	constructor(o: { targetTaskList: INTaskList; taskTitles: NSArray<INSpeakableString>; spatialEventTrigger: INSpatialEventTrigger; temporalEventTrigger: INTemporalEventTrigger; priority: INTaskPriority; });
	...
	initWithTargetTaskListTaskTitlesSpatialEventTriggerTemporalEventTriggerPriority(targetTaskList: INTaskList, taskTitles: NSArray<INSpeakableString>, spatialEventTrigger: INSpatialEventTrigger, temporalEventTrigger: INTemporalEventTrigger, priority: INTaskPriority): this;
}
...
declare class INAddTasksTargetTaskListResolutionResult extends INTaskListResolutionResult {
	...
	static disambiguationWithTaskListsToDisambiguate(taskListsToDisambiguate: NSArray<INTaskList>): INAddTasksTargetTaskListResolutionResult; // inherited from INTaskListResolutionResult
...
declare class INAddTasksTemporalEventTriggerResolutionResult extends INTemporalEventTriggerResolutionResult {
	...
	static disambiguationWithTemporalEventTriggersToDisambiguate(temporalEventTriggersToDisambiguate: NSArray<INTemporalEventTrigger>): INAddTasksTemporalEventTriggerResolutionResult; // inherited from INTemporalEventTriggerResolutionResult
...
declare class INBoatReservation extends INReservation implements NSCopying, NSSecureCoding {
	...
	constructor(o: { itemReference: INSpeakableString; reservationNumber: string; bookingTime: Date; reservationStatus: INReservationStatus; reservationHolderName: string; actions: NSArray<INReservationAction>; URL: NSURL; reservedSeat: INSeat; boatTrip: INBoatTrip; });
...
declare class INBusReservation extends INReservation implements NSCopying, NSSecureCoding {
	...
	constructor(o: { itemReference: INSpeakableString; reservationNumber: string; bookingTime: Date; reservationStatus: INReservationStatus; reservationHolderName: string; actions: NSArray<INReservationAction>; URL: NSURL; reservedSeat: INSeat; busTrip: INBusTrip; });
...
declare class INCallRecord extends NSObject implements NSCopying, NSSecureCoding {
	...
	constructor(o: { identifier: string; dateCreated: Date; callRecordType: INCallRecordType; callCapability: INCallCapability; callDuration: number; unseen: number; participants: NSArray<INPerson>; numberOfCalls: number; isCallerIdBlocked: number; });
...
declare class INCallRecordFilter extends NSObject implements NSCopying, NSSecureCoding {
	...
	constructor(o: { participants: NSArray<INPerson>; callTypes: INCallRecordTypeOptions; callCapability: INCallCapability; });
	...
	initWithParticipantsCallTypesCallCapability(participants: NSArray<INPerson>, callTypes: INCallRecordTypeOptions, callCapability: INCallCapability): this;
}
...
declare class INCallRecordResolutionResult extends INIntentResolutionResult {
	...
	static disambiguationWithCallRecordsToDisambiguate(callRecordsToDisambiguate: NSArray<INCallRecord>): INCallRecordResolutionResult;
...
declare class INCar extends NSObject implements NSCopying, NSSecureCoding {
	...
	constructor(o: { carIdentifier: string; displayName: string; year: string; make: string; model: string; color: any; headUnit: INCarHeadUnit; supportedChargingConnectors: NSArray<string>; });
	...
	initWithCarIdentifierDisplayNameYearMakeModelColorHeadUnitSupportedChargingConnectors(carIdentifier: string, displayName: string, year: string, make: string, model: string, color: any, headUnit: INCarHeadUnit, supportedChargingConnectors: NSArray<string>): this;
...
declare class INDeleteTasksIntent extends INIntent {
	...
	constructor(o: { taskList: INTaskList; tasks: NSArray<INTask>; all: number; });

	initWithTaskListTasksAll(taskList: INTaskList, tasks: NSArray<INTask>, all: number): this;
}
...
declare class INDeleteTasksTaskListResolutionResult extends INTaskListResolutionResult {
	...
	static disambiguationWithTaskListsToDisambiguate(taskListsToDisambiguate: NSArray<INTaskList>): INDeleteTasksTaskListResolutionResult; // inherited from INTaskListResolutionResult
...
declare class INDeleteTasksTaskResolutionResult extends INTaskResolutionResult {
	...
	static disambiguationWithTasksToDisambiguate(tasksToDisambiguate: NSArray<INTask>): INDeleteTasksTaskResolutionResult; // inherited from INTaskResolutionResult
...
declare class INEnergyResolutionResult extends INIntentResolutionResult {
	...
	static disambiguationWithEnergyToDisambiguate(energyToDisambiguate: NSArray<NSMeasurement<NSUnitEnergy>>): INEnergyResolutionResult;
...
declare class INFileResolutionResult extends INIntentResolutionResult {
	...
	static disambiguationWithFilesToDisambiguate(filesToDisambiguate: NSArray<INFile>): INFileResolutionResult;
...
declare class INFlightReservation extends INReservation implements NSCopying, NSSecureCoding {
	...
	constructor(o: { itemReference: INSpeakableString; reservationNumber: string; bookingTime: Date; reservationStatus: INReservationStatus; reservationHolderName: string; actions: NSArray<INReservationAction>; reservedSeat: INSeat; flight: INFlight; });

	constructor(o: { itemReference: INSpeakableString; reservationNumber: string; bookingTime: Date; reservationStatus: INReservationStatus; reservationHolderName: string; actions: NSArray<INReservationAction>; URL: NSURL; reservedSeat: INSeat; flight: INFlight; });
...
declare class INGetReservationDetailsIntent extends INIntent {
	...
	constructor(o: { reservationContainerReference: INSpeakableString; reservationItemReferences: NSArray<INSpeakableString>; });

	initWithReservationContainerReferenceReservationItemReferences(reservationContainerReference: INSpeakableString, reservationItemReferences: NSArray<INSpeakableString>): this;
}
...
declare class INLengthResolutionResult extends INIntentResolutionResult {
	...
	static disambiguationWithLengthsToDisambiguate(lengthsToDisambiguate: NSArray<NSMeasurement<NSUnitLength>>): INLengthResolutionResult;
...
declare class INMassResolutionResult extends INIntentResolutionResult {
	...
	static disambiguationWithMassToDisambiguate(massToDisambiguate: NSArray<NSMeasurement<NSUnitMass>>): INMassResolutionResult;
...
declare class INMediaDestinationResolutionResult extends INIntentResolutionResult {
	...
	static disambiguationWithMediaDestinationsToDisambiguate(mediaDestinationsToDisambiguate: NSArray<INMediaDestination>): INMediaDestinationResolutionResult;
...
declare class INMediaItemResolutionResult extends INIntentResolutionResult {
	...
	static disambiguationWithMediaItemsToDisambiguate(mediaItemsToDisambiguate: NSArray<INMediaItem>): INMediaItemResolutionResult;
	...
	static successesWithResolvedMediaItems(resolvedMediaItems: NSArray<INMediaItem>): NSArray<INMediaItemResolutionResult>;
...
declare class INMediaSearch extends NSObject implements NSCopying, NSSecureCoding {
	...
	constructor(o: { mediaType: INMediaItemType; sortOrder: INMediaSortOrder; mediaName: string; artistName: string; albumName: string; genreNames: NSArray<string>; moodNames: NSArray<string>; releaseDate: INDateComponentsRange; reference: INMediaReference; mediaIdentifier: string; });
...
declare class INMessage extends NSObject implements NSCopying, NSSecureCoding {
	...
	constructor(o: { identifier: string; conversationIdentifier: string; content: string; dateSent: Date; sender: INPerson; recipients: NSArray<INPerson>; groupName: INSpeakableString; messageType: INMessageType; serviceName: string; });
	...
	initWithIdentifierConversationIdentifierContentDateSentSenderRecipientsGroupNameMessageTypeServiceName(identifier: string, conversationIdentifier: string, content: string, dateSent: Date, sender: INPerson, recipients: NSArray<INPerson>, groupName: INSpeakableString, messageType: INMessageType, serviceName: string): this;
...
declare class INObjectCollection<ObjectType> extends NSObject implements NSCopying, NSSecureCoding {
	...
	readonly allItems: NSArray<ObjectType>;

	readonly sections: NSArray<INObjectSection<ObjectType>>;
	...
	constructor(o: { items: NSArray<ObjectType>; });

	constructor(o: { sections: NSArray<INObjectSection<ObjectType>>; });
	...
	initWithItems(items: NSArray<ObjectType>): this;

	initWithSections(sections: NSArray<INObjectSection<ObjectType>>): this;
}
...
declare class INObjectResolutionResult extends INIntentResolutionResult {
	...
	static disambiguationWithObjectsToDisambiguate(objectsToDisambiguate: NSArray<INObject>): INObjectResolutionResult;
...
declare class INObjectSection<ObjectType> extends NSObject implements NSCopying, NSSecureCoding {
	...
	readonly items: NSArray<ObjectType>;
	...
	constructor(o: { title: string; items: NSArray<ObjectType>; });
	...
	initWithTitleItems(title: string, items: NSArray<ObjectType>): this;
}
...
declare class INPaymentMethodResolutionResult extends INIntentResolutionResult {
	...
	static disambiguationWithPaymentMethodsToDisambiguate(paymentMethodsToDisambiguate: NSArray<INPaymentMethod>): INPaymentMethodResolutionResult;
...
declare class INPlayMediaIntent extends INIntent {
	...
	constructor(o: { mediaItems: NSArray<INMediaItem>; mediaContainer: INMediaItem; playShuffled: number; playbackRepeatMode: INPlaybackRepeatMode; resumePlayback: number; });

	constructor(o: { mediaItems: NSArray<INMediaItem>; mediaContainer: INMediaItem; playShuffled: number; playbackRepeatMode: INPlaybackRepeatMode; resumePlayback: number; playbackQueueLocation: INPlaybackQueueLocation; playbackSpeed: number; mediaSearch: INMediaSearch; });

	initWithMediaItemsMediaContainerPlayShuffledPlaybackRepeatModeResumePlayback(mediaItems: NSArray<INMediaItem>, mediaContainer: INMediaItem, playShuffled: number, playbackRepeatMode: INPlaybackRepeatMode, resumePlayback: number): this;
...
declare class INPlayMediaMediaItemResolutionResult extends INMediaItemResolutionResult {
	...
	static disambiguationWithMediaItemsToDisambiguate(mediaItemsToDisambiguate: NSArray<INMediaItem>): INPlayMediaMediaItemResolutionResult; // inherited from INMediaItemResolutionResult
...
declare class INRelevantShortcutStore extends NSObject {
	...
	setRelevantShortcutsCompletionHandler(shortcuts: NSArray<INRelevantShortcut>, completionHandler: (p1: NSError) => void): void;
}
...
declare class INRestaurantReservation extends INReservation implements NSCopying, NSSecureCoding {
	...
	constructor(o: { itemReference: INSpeakableString; reservationNumber: string; bookingTime: Date; reservationStatus: INReservationStatus; reservationHolderName: string; actions: NSArray<INReservationAction>; reservationDuration: INDateComponentsRange; partySize: number; restaurantLocation: CLPlacemark; });

	constructor(o: { itemReference: INSpeakableString; reservationNumber: string; bookingTime: Date; reservationStatus: INReservationStatus; reservationHolderName: string; actions: NSArray<INReservationAction>; URL: NSURL; reservationDuration: INDateComponentsRange; partySize: number; restaurantLocation: CLPlacemark; });
...
declare class INSearchForMediaIntent extends INIntent {
	...
	constructor(o: { mediaItems: NSArray<INMediaItem>; mediaSearch: INMediaSearch; });

	initWithMediaItemsMediaSearch(mediaItems: NSArray<INMediaItem>, mediaSearch: INMediaSearch): this;
}
...
declare class INSearchForMediaMediaItemResolutionResult extends INMediaItemResolutionResult {
	...
	static disambiguationWithMediaItemsToDisambiguate(mediaItemsToDisambiguate: NSArray<INMediaItem>): INSearchForMediaMediaItemResolutionResult; // inherited from INMediaItemResolutionResult
...
declare class INSearchForMessagesIntent extends INIntent {
	...
	constructor(o: { recipients: NSArray<INPerson>; senders: NSArray<INPerson>; searchTerms: NSArray<string>; attributes: INMessageAttributeOptions; dateTimeRange: INDateComponentsRange; identifiers: NSArray<string>; notificationIdentifiers: NSArray<string>; speakableGroupNames: NSArray<INSpeakableString>; conversationIdentifiers: NSArray<string>; });
...
declare class INSendMessageIntent extends INIntent implements UNNotificationContentProviding {
	...
	constructor(o: { recipients: NSArray<INPerson>; outgoingMessageType: INOutgoingMessageType; content: string; speakableGroupName: INSpeakableString; conversationIdentifier: string; serviceName: string; sender: INPerson; });

	constructor(o: { recipients: NSArray<INPerson>; outgoingMessageType: INOutgoingMessageType; content: string; speakableGroupName: INSpeakableString; conversationIdentifier: string; serviceName: string; sender: INPerson; attachments: NSArray<INSendMessageAttachment>; });
	...
	initWithRecipientsOutgoingMessageTypeContentSpeakableGroupNameConversationIdentifierServiceNameSender(recipients: NSArray<INPerson>, outgoingMessageType: INOutgoingMessageType, content: string, speakableGroupName: INSpeakableString, conversationIdentifier: string, serviceName: string, sender: INPerson): this;

	initWithRecipientsOutgoingMessageTypeContentSpeakableGroupNameConversationIdentifierServiceNameSenderAttachments(recipients: NSArray<INPerson>, outgoingMessageType: INOutgoingMessageType, content: string, speakableGroupName: INSpeakableString, conversationIdentifier: string, serviceName: string, sender: INPerson, attachments: NSArray<INSendMessageAttachment>): this;
...
declare class INSetTaskAttributeTemporalEventTriggerResolutionResult extends INTemporalEventTriggerResolutionResult {
	...
	static disambiguationWithTemporalEventTriggersToDisambiguate(temporalEventTriggersToDisambiguate: NSArray<INTemporalEventTrigger>): INSetTaskAttributeTemporalEventTriggerResolutionResult; // inherited from INTemporalEventTriggerResolutionResult
...
declare class INSnoozeTasksIntent extends INIntent {
	...
	constructor(o: { tasks: NSArray<INTask>; nextTriggerTime: INDateComponentsRange; all: number; });

	initWithTasksNextTriggerTimeAll(tasks: NSArray<INTask>, nextTriggerTime: INDateComponentsRange, all: number): this;
}
...
declare class INSnoozeTasksTaskResolutionResult extends INTaskResolutionResult {
	...
	static disambiguationWithTasksToDisambiguate(tasksToDisambiguate: NSArray<INTask>): INSnoozeTasksTaskResolutionResult; // inherited from INTaskResolutionResult
...
declare class INSpeedResolutionResult extends INIntentResolutionResult {
	...
	static disambiguationWithSpeedToDisambiguate(speedToDisambiguate: NSArray<NSMeasurement<NSUnitSpeed>>): INSpeedResolutionResult;
...
declare class INStartCallCallRecordToCallBackResolutionResult extends INCallRecordResolutionResult {
	...
	static disambiguationWithCallRecordsToDisambiguate(callRecordsToDisambiguate: NSArray<INCallRecord>): INStartCallCallRecordToCallBackResolutionResult; // inherited from INCallRecordResolutionResult
...
declare class INStartCallContactResolutionResult extends INPersonResolutionResult {
	...
	static disambiguationWithPeopleToDisambiguate(peopleToDisambiguate: NSArray<INPerson>): INStartCallContactResolutionResult; // inherited from INPersonResolutionResult
...
declare class INStartCallIntent extends INIntent implements UNNotificationContentProviding {
	...
	constructor(o: { audioRoute: INCallAudioRoute; destinationType: INCallDestinationType; contacts: NSArray<INPerson>; recordTypeForRedialing: INCallRecordType; callCapability: INCallCapability; });

	constructor(o: { callRecordFilter: INCallRecordFilter; callRecordToCallBack: INCallRecord; audioRoute: INCallAudioRoute; destinationType: INCallDestinationType; contacts: NSArray<INPerson>; callCapability: INCallCapability; });

	class(): typeof NSObject;

	conformsToProtocol(aProtocol: any /* Protocol */): boolean;

	initWithAudioRouteDestinationTypeContactsRecordTypeForRedialingCallCapability(audioRoute: INCallAudioRoute, destinationType: INCallDestinationType, contacts: NSArray<INPerson>, recordTypeForRedialing: INCallRecordType, callCapability: INCallCapability): this;

	initWithCallRecordFilterCallRecordToCallBackAudioRouteDestinationTypeContactsCallCapability(callRecordFilter: INCallRecordFilter, callRecordToCallBack: INCallRecord, audioRoute: INCallAudioRoute, destinationType: INCallDestinationType, contacts: NSArray<INPerson>, callCapability: INCallCapability): this;
...
declare class INTicketedEventReservation extends INReservation implements NSCopying, NSSecureCoding {
	...
	constructor(o: { itemReference: INSpeakableString; reservationNumber: string; bookingTime: Date; reservationStatus: INReservationStatus; reservationHolderName: string; actions: NSArray<INReservationAction>; reservedSeat: INSeat; event: INTicketedEvent; });

	constructor(o: { itemReference: INSpeakableString; reservationNumber: string; bookingTime: Date; reservationStatus: INReservationStatus; reservationHolderName: string; actions: NSArray<INReservationAction>; URL: NSURL; reservedSeat: INSeat; event: INTicketedEvent; });
...
declare class INTrainReservation extends INReservation implements NSCopying, NSSecureCoding {
	...
	constructor(o: { itemReference: INSpeakableString; reservationNumber: string; bookingTime: Date; reservationStatus: INReservationStatus; reservationHolderName: string; actions: NSArray<INReservationAction>; reservedSeat: INSeat; trainTrip: INTrainTrip; });

	constructor(o: { itemReference: INSpeakableString; reservationNumber: string; bookingTime: Date; reservationStatus: INReservationStatus; reservationHolderName: string; actions: NSArray<INReservationAction>; URL: NSURL; reservedSeat: INSeat; trainTrip: INTrainTrip; });
...
declare class INURLResolutionResult extends INIntentResolutionResult {
	...
	static disambiguationWithURLsToDisambiguate(urlsToDisambiguate: NSArray<NSURL>): INURLResolutionResult;
...
declare class INUpdateMediaAffinityIntent extends INIntent {
	...
	constructor(o: { mediaItems: NSArray<INMediaItem>; mediaSearch: INMediaSearch; affinityType: INMediaAffinityType; });

	initWithMediaItemsMediaSearchAffinityType(mediaItems: NSArray<INMediaItem>, mediaSearch: INMediaSearch, affinityType: INMediaAffinityType): this;
}
...
declare class INUpdateMediaAffinityMediaItemResolutionResult extends INMediaItemResolutionResult {
	...
	static disambiguationWithMediaItemsToDisambiguate(mediaItemsToDisambiguate: NSArray<INMediaItem>): INUpdateMediaAffinityMediaItemResolutionResult; // inherited from INMediaItemResolutionResult
...
declare class INVoiceShortcutCenter extends NSObject {
	...
	setShortcutSuggestions(suggestions: NSArray<INShortcut>): void;
}
...
declare class INVolumeResolutionResult extends INIntentResolutionResult {
	...
	static disambiguationWithVolumeToDisambiguate(volumeToDisambiguate: NSArray<NSMeasurement<NSUnitVolume>>): INVolumeResolutionResult;
