...
declare class INUIAddVoiceShortcutButton extends UIButton {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): INUIAddVoiceShortcutButton; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): INUIAddVoiceShortcutButton; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): INUIAddVoiceShortcutButton; // inherited from UIAppearance
