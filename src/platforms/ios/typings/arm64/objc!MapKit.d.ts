...
declare class MKGradientPolylineRenderer extends MKPolylineRenderer {
	...
	setColorsAtLocations(colors: NSArray<UIColor>, locations: NSArray<number>): void;
}
...
declare class MKMapItem extends NSObject implements NSItemProviderReading, NSItemProviderWriting, NSSecureCoding {
	...
	static openMapsWithItemsLaunchOptionsFromSceneCompletionHandler(mapItems: NSArray<MKMapItem>, launchOptions: NSDictionary<string, any>, scene: UIScene, completion: (p1: boolean) => void): void;
...
declare class MKMultiPolygon extends MKShape implements MKGeoJSONObject, MKOverlay {
	...
	constructor(o: { polygons: NSArray<MKPolygon>; });

	class(): typeof NSObject;

	conformsToProtocol(aProtocol: any /* Protocol */): boolean;

	initWithPolygons(polygons: NSArray<MKPolygon>): this;
...
declare class MKMultiPolyline extends MKShape implements MKGeoJSONObject, MKOverlay {
	...
	constructor(o: { polylines: NSArray<MKPolyline>; });

	class(): typeof NSObject;

	conformsToProtocol(aProtocol: any /* Protocol */): boolean;

	initWithPolylines(polylines: NSArray<MKPolyline>): this;
...
declare class MKPointOfInterestFilter extends NSObject implements NSCopying, NSSecureCoding {
	...
	constructor(o: { excludingCategories: NSArray<string>; });

	constructor(o: { includingCategories: NSArray<string>; });
	...
	initExcludingCategories(categories: NSArray<string>): this;

	initIncludingCategories(categories: NSArray<string>): this;
...
declare class MKUserLocationView extends MKAnnotationView {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): MKUserLocationView; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): MKUserLocationView; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): MKUserLocationView; // inherited from UIAppearance
