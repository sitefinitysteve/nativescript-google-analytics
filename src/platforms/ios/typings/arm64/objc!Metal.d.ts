...
interface MTLComputePipelineState extends NSObjectProtocol {
	...
	newComputePipelineStateWithAdditionalBinaryFunctionsError(functions: NSArray<MTLFunction>): MTLComputePipelineState;
...
declare class MTLFunctionStitchingFunctionNode extends NSObject implements MTLFunctionStitchingNode {
	...
	constructor(o: { name: string; arguments: NSArray<MTLFunctionStitchingNode>; controlDependencies: NSArray<MTLFunctionStitchingFunctionNode>; });
	...
	initWithNameArgumentsControlDependencies(name: string, _arguments: NSArray<MTLFunctionStitchingNode>, controlDependencies: NSArray<MTLFunctionStitchingFunctionNode>): this;
...
declare class MTLFunctionStitchingGraph extends NSObject implements NSCopying {
	...
	constructor(o: { functionName: string; nodes: NSArray<MTLFunctionStitchingFunctionNode>; outputNode: MTLFunctionStitchingFunctionNode; attributes: NSArray<MTLFunctionStitchingAttribute>; });

	copyWithZone(zone: interop.Pointer | interop.Reference<any>): any;

	initWithFunctionNameNodesOutputNodeAttributes(functionName: string, nodes: NSArray<MTLFunctionStitchingFunctionNode>, outputNode: MTLFunctionStitchingFunctionNode, attributes: NSArray<MTLFunctionStitchingAttribute>): this;
}
