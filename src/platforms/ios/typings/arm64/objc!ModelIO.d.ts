...
declare class MDLAnimatedVector2 extends MDLAnimatedValue {
	...
	double2AtTime(time: number);

	float2AtTime(time: number);

	getDouble2ArrayMaxCount(valuesArray: interop.Pointer | interop.Reference<>, maxCount: number): number;

	getFloat2ArrayMaxCount(valuesArray: interop.Pointer | interop.Reference<>, maxCount: number): number;

	resetWithDouble2ArrayAtTimesCount(valuesArray: interop.Pointer | interop.Reference<>, timesArray: interop.Pointer | interop.Reference<number>, count: number): void;

	resetWithFloat2ArrayAtTimesCount(valuesArray: interop.Pointer | interop.Reference<>, timesArray: interop.Pointer | interop.Reference<number>, count: number): void;

	setDouble2AtTime(value,time: number): void;

	setFloat2AtTime(value,time: number): void;
}
...
declare class MDLAnimatedVector3 extends MDLAnimatedValue {
	...
	double3AtTime(time: number);

	float3AtTime(time: number);

	getDouble3ArrayMaxCount(valuesArray: interop.Pointer | interop.Reference<>, maxCount: number): number;

	getFloat3ArrayMaxCount(valuesArray: interop.Pointer | interop.Reference<>, maxCount: number): number;

	resetWithDouble3ArrayAtTimesCount(valuesArray: interop.Pointer | interop.Reference<>, timesArray: interop.Pointer | interop.Reference<number>, count: number): void;

	resetWithFloat3ArrayAtTimesCount(valuesArray: interop.Pointer | interop.Reference<>, timesArray: interop.Pointer | interop.Reference<number>, count: number): void;

	setDouble3AtTime(value,time: number): void;

	setFloat3AtTime(value,time: number): void;
}
...
declare class MDLAnimatedVector3Array extends MDLAnimatedValue {
	...
	getDouble3ArrayMaxCountAtTime(array: interop.Pointer | interop.Reference<>, maxCount: number, time: number): number;

	getFloat3ArrayMaxCount(valuesArray: interop.Pointer | interop.Reference<>, maxCount: number): number;

	getFloat3ArrayMaxCountAtTime(array: interop.Pointer | interop.Reference<>, maxCount: number, time: number): number;

	initWithElementCount(arrayElementCount: number): this;

	resetWithDouble3ArrayCountAtTimesCount(valuesArray: interop.Pointer | interop.Reference<>, valuesCount: number, timesArray: interop.Pointer | interop.Reference<number>, timesCount: number): void;

	resetWithFloat3ArrayCountAtTimesCount(valuesArray: interop.Pointer | interop.Reference<>, valuesCount: number, timesArray: interop.Pointer | interop.Reference<number>, timesCount: number): void;

	setDouble3ArrayCountAtTime(array: interop.Pointer | interop.Reference<>, count: number, time: number): void;

	setFloat3ArrayCountAtTime(array: interop.Pointer | interop.Reference<>, count: number, time: number): void;
}
...
declare class MDLAnimatedVector4 extends MDLAnimatedValue {
	...
	double4AtTime(time: number);

	float4AtTime(time: number);

	getDouble4ArrayMaxCount(valuesArray: interop.Pointer | interop.Reference<>, maxCount: number): number;

	getFloat4ArrayMaxCount(valuesArray: interop.Pointer | interop.Reference<>, maxCount: number): number;

	resetWithDouble4ArrayAtTimesCount(valuesArray: interop.Pointer | interop.Reference<>, timesArray: interop.Pointer | interop.Reference<number>, count: number): void;

	resetWithFloat4ArrayAtTimesCount(valuesArray: interop.Pointer | interop.Reference<>, timesArray: interop.Pointer | interop.Reference<number>, count: number): void;

	setDouble4AtTime(value,time: number): void;

	setFloat4AtTime(value,time: number): void;
}
...
declare class MDLCamera extends MDLObject {
	...
	bokehKernelWithSize(size): MDLTexture;

	frameBoundingBoxSetNearAndFar(boundingBox: MDLAxisAlignedBoundingBox, setNearAndFar: boolean): void;

	lookAt(focusPosition): void;

	lookAtFrom(focusPosition,cameraPosition): void;

	rayToForViewPort(pixel,size);
}
...
declare class MDLCheckerboardTexture extends MDLTexture {
	...
	static irradianceTextureCubeWithTextureNameDimensions(texture: MDLTexture, name: string, dimensions): MDLCheckerboardTexture; // inherited from MDLTexture

	static irradianceTextureCubeWithTextureNameDimensionsRoughness(texture: MDLTexture, name: string, dimensions,roughness: number): MDLCheckerboardTexture; // inherited from MDLTexture
	...
	constructor(o: { divisions: number; name: string; dimensions; channelCount: number; channelEncoding: MDLTextureChannelEncoding; color1: any; color2: any; });

	initWithDivisionsNameDimensionsChannelCountChannelEncodingColor1Color2(divisions: number, name: string, dimensions,channelCount: number, channelEncoding: MDLTextureChannelEncoding, color1: any, color2: any): this;
}
...
declare class MDLColorSwatchTexture extends MDLTexture {
	...
	static irradianceTextureCubeWithTextureNameDimensions(texture: MDLTexture, name: string, dimensions): MDLColorSwatchTexture; // inherited from MDLTexture

	static irradianceTextureCubeWithTextureNameDimensionsRoughness(texture: MDLTexture, name: string, dimensions,roughness: number): MDLColorSwatchTexture; // inherited from MDLTexture
	...
	constructor(o: { colorGradientFrom: any; toColor: any; name: string; textureDimensions; });

	constructor(o: { colorTemperatureGradientFrom: number; toColorTemperature: number; name: string; textureDimensions; });

	initWithColorGradientFromToColorNameTextureDimensions(color1: any, color2: any, name: string, textureDimensions): this;

	initWithColorTemperatureGradientFromToColorTemperatureNameTextureDimensions(colorTemperature1: number, colorTemperature2: number, name: string, textureDimensions): this;
}
...
declare class MDLLight extends MDLObject {
	...
	irradianceAtPoint(point): any;

	irradianceAtPointColorSpace(point,colorSpace: any): any;
}
...
interface MDLLightProbeIrradianceDataSource extends NSObjectProtocol {
	...
	sphericalHarmonicsCoefficientsAtPosition?(position): NSData;
}
...
declare class MDLMaterialProperty extends NSObject implements MDLNamed, NSCopying {
	...
	constructor(o: { name: string; semantic: MDLMaterialSemantic; float2; });

	constructor(o: { name: string; semantic: MDLMaterialSemantic; float3; });

	constructor(o: { name: string; semantic: MDLMaterialSemantic; float4; });
	...
	initWithNameSemanticFloat2(name: string, semantic: MDLMaterialSemantic, value): this;

	initWithNameSemanticFloat3(name: string, semantic: MDLMaterialSemantic, value): this;

	initWithNameSemanticFloat4(name: string, semantic: MDLMaterialSemantic, value): this;
...
declare class MDLMesh extends MDLObject {
	...
	static newBoxWithDimensionsSegmentsGeometryTypeInwardNormalsAllocator(dimensions,segments,geometryType: MDLGeometryType, inwardNormals: boolean, allocator: MDLMeshBufferAllocator): MDLMesh;

	static newCapsuleWithHeightRadiiRadialSegmentsVerticalSegmentsHemisphereSegmentsGeometryTypeInwardNormalsAllocator(height: number, radii,radialSegments: number, verticalSegments: number, hemisphereSegments: number, geometryType: MDLGeometryType, inwardNormals: boolean, allocator: MDLMeshBufferAllocator): MDLMesh;

	static newCylinderWithHeightRadiiRadialSegmentsVerticalSegmentsGeometryTypeInwardNormalsAllocator(height: number, radii,radialSegments: number, verticalSegments: number, geometryType: MDLGeometryType, inwardNormals: boolean, allocator: MDLMeshBufferAllocator): MDLMesh;

	static newEllipsoidWithRadiiRadialSegmentsVerticalSegmentsGeometryTypeInwardNormalsHemisphereAllocator(radii,radialSegments: number, verticalSegments: number, geometryType: MDLGeometryType, inwardNormals: boolean, hemisphere: boolean, allocator: MDLMeshBufferAllocator): MDLMesh;

	static newEllipticalConeWithHeightRadiiRadialSegmentsVerticalSegmentsGeometryTypeInwardNormalsAllocator(height: number, radii,radialSegments: number, verticalSegments: number, geometryType: MDLGeometryType, inwardNormals: boolean, allocator: MDLMeshBufferAllocator): MDLMesh;
	...
	static newPlaneWithDimensionsSegmentsGeometryTypeAllocator(dimensions,segments,geometryType: MDLGeometryType, allocator: MDLMeshBufferAllocator): MDLMesh;
	...
	constructor(o: { boxWithExtent; segments; inwardNormals: boolean; geometryType: MDLGeometryType; allocator: MDLMeshBufferAllocator; });

	constructor(o: { capsuleWithExtent; cylinderSegments; hemisphereSegments: number; inwardNormals: boolean; geometryType: MDLGeometryType; allocator: MDLMeshBufferAllocator; });

	constructor(o: { coneWithExtent; segments; inwardNormals: boolean; cap: boolean; geometryType: MDLGeometryType; allocator: MDLMeshBufferAllocator; });

	constructor(o: { cylinderWithExtent; segments; inwardNormals: boolean; topCap: boolean; bottomCap: boolean; geometryType: MDLGeometryType; allocator: MDLMeshBufferAllocator; });

	constructor(o: { hemisphereWithExtent; segments; inwardNormals: boolean; cap: boolean; geometryType: MDLGeometryType; allocator: MDLMeshBufferAllocator; });

	constructor(o: { icosahedronWithExtent; inwardNormals: boolean; geometryType: MDLGeometryType; allocator: MDLMeshBufferAllocator; });
	...
	constructor(o: { planeWithExtent; segments; geometryType: MDLGeometryType; allocator: MDLMeshBufferAllocator; });

	constructor(o: { sphereWithExtent; segments; inwardNormals: boolean; geometryType: MDLGeometryType; allocator: MDLMeshBufferAllocator; });
	...
	generateAmbientOcclusionTextureWithSizeRaysPerSampleAttenuationFactorObjectsToConsiderVertexAttributeNamedMaterialPropertyNamed(textureSize,raysPerSample: number, attenuationFactor: number, objectsToConsider: NSArray<MDLObject>, vertexAttributeName: string, materialPropertyName: string): boolean;
	...
	generateLightMapTextureWithTextureSizeLightsToConsiderObjectsToConsiderVertexAttributeNamedMaterialPropertyNamed(textureSize,lightsToConsider: NSArray<MDLLight>, objectsToConsider: NSArray<MDLObject>, vertexAttributeName: string, materialPropertyName: string): boolean;
	...
	initBoxWithExtentSegmentsInwardNormalsGeometryTypeAllocator(extent,segments,inwardNormals: boolean, geometryType: MDLGeometryType, allocator: MDLMeshBufferAllocator): this;

	initCapsuleWithExtentCylinderSegmentsHemisphereSegmentsInwardNormalsGeometryTypeAllocator(extent,segments,hemisphereSegments: number, inwardNormals: boolean, geometryType: MDLGeometryType, allocator: MDLMeshBufferAllocator): this;

	initConeWithExtentSegmentsInwardNormalsCapGeometryTypeAllocator(extent,segments,inwardNormals: boolean, cap: boolean, geometryType: MDLGeometryType, allocator: MDLMeshBufferAllocator): this;

	initCylinderWithExtentSegmentsInwardNormalsTopCapBottomCapGeometryTypeAllocator(extent,segments,inwardNormals: boolean, topCap: boolean, bottomCap: boolean, geometryType: MDLGeometryType, allocator: MDLMeshBufferAllocator): this;

	initHemisphereWithExtentSegmentsInwardNormalsCapGeometryTypeAllocator(extent,segments,inwardNormals: boolean, cap: boolean, geometryType: MDLGeometryType, allocator: MDLMeshBufferAllocator): this;

	initIcosahedronWithExtentInwardNormalsGeometryTypeAllocator(extent,inwardNormals: boolean, geometryType: MDLGeometryType, allocator: MDLMeshBufferAllocator): this;
	...
	initPlaneWithExtentSegmentsGeometryTypeAllocator(extent,segments,geometryType: MDLGeometryType, allocator: MDLMeshBufferAllocator): this;

	initSphereWithExtentSegmentsInwardNormalsGeometryTypeAllocator(extent,segments,inwardNormals: boolean, geometryType: MDLGeometryType, allocator: MDLMeshBufferAllocator): this;
...
declare class MDLNoiseTexture extends MDLTexture {
	...
	static irradianceTextureCubeWithTextureNameDimensions(texture: MDLTexture, name: string, dimensions): MDLNoiseTexture; // inherited from MDLTexture

	static irradianceTextureCubeWithTextureNameDimensionsRoughness(texture: MDLTexture, name: string, dimensions,roughness: number): MDLNoiseTexture; // inherited from MDLTexture
	...
	constructor(o: { cellularNoiseWithFrequency: number; name: string; textureDimensions; channelEncoding: MDLTextureChannelEncoding; });

	constructor(o: { scalarNoiseWithSmoothness: number; name: string; textureDimensions; channelCount: number; channelEncoding: MDLTextureChannelEncoding; grayscale: boolean; });

	constructor(o: { vectorNoiseWithSmoothness: number; name: string; textureDimensions; channelEncoding: MDLTextureChannelEncoding; });

	initCellularNoiseWithFrequencyNameTextureDimensionsChannelEncoding(frequency: number, name: string, textureDimensions,channelEncoding: MDLTextureChannelEncoding): this;

	initScalarNoiseWithSmoothnessNameTextureDimensionsChannelCountChannelEncodingGrayscale(smoothness: number, name: string, textureDimensions,channelCount: number, channelEncoding: MDLTextureChannelEncoding, grayscale: boolean): this;

	initVectorNoiseWithSmoothnessNameTextureDimensionsChannelEncoding(smoothness: number, name: string, textureDimensions,channelEncoding: MDLTextureChannelEncoding): this;
}
...
declare class MDLNormalMapTexture extends MDLTexture {
	...
	static irradianceTextureCubeWithTextureNameDimensions(texture: MDLTexture, name: string, dimensions): MDLNormalMapTexture; // inherited from MDLTexture

	static irradianceTextureCubeWithTextureNameDimensionsRoughness(texture: MDLTexture, name: string, dimensions,roughness: number): MDLNormalMapTexture; // inherited from MDLTexture
...
declare class MDLSkyCubeTexture extends MDLTexture {
	...
	static irradianceTextureCubeWithTextureNameDimensions(texture: MDLTexture, name: string, dimensions): MDLSkyCubeTexture; // inherited from MDLTexture

	static irradianceTextureCubeWithTextureNameDimensionsRoughness(texture: MDLTexture, name: string, dimensions,roughness: number): MDLSkyCubeTexture; // inherited from MDLTexture
	...
	constructor(o: { name: string; channelEncoding: MDLTextureChannelEncoding; textureDimensions; turbidity: number; sunElevation: number; sunAzimuth: number; upperAtmosphereScattering: number; groundAlbedo: number; });

	constructor(o: { name: string; channelEncoding: MDLTextureChannelEncoding; textureDimensions; turbidity: number; sunElevation: number; upperAtmosphereScattering: number; groundAlbedo: number; });

	initWithNameChannelEncodingTextureDimensionsTurbiditySunElevationSunAzimuthUpperAtmosphereScatteringGroundAlbedo(name: string, channelEncoding: MDLTextureChannelEncoding, textureDimensions,turbidity: number, sunElevation: number, sunAzimuth: number, upperAtmosphereScattering: number, groundAlbedo: number): this;

	initWithNameChannelEncodingTextureDimensionsTurbiditySunElevationUpperAtmosphereScatteringGroundAlbedo(name: string, channelEncoding: MDLTextureChannelEncoding, textureDimensions,turbidity: number, sunElevation: number, upperAtmosphereScattering: number, groundAlbedo: number): this;
...
declare class MDLTexture extends NSObject implements MDLNamed {
	...
	static irradianceTextureCubeWithTextureNameDimensions(texture: MDLTexture, name: string, dimensions): MDLTexture;

	static irradianceTextureCubeWithTextureNameDimensionsRoughness(texture: MDLTexture, name: string, dimensions,roughness: number): MDLTexture;
	...
	constructor(o: { data: NSData; topLeftOrigin: boolean; name: string; dimensions; rowStride: number; channelCount: number; channelEncoding: MDLTextureChannelEncoding; isCube: boolean; });

	imageFromTexture(): any;

	imageFromTextureAtLevel(level: number): any;

	initWithDataTopLeftOriginNameDimensionsRowStrideChannelCountChannelEncodingIsCube(pixelData: NSData, topLeftOrigin: boolean, name: string, dimensions,rowStride: number, channelCount: number, channelEncoding: MDLTextureChannelEncoding, isCube: boolean): this;
...
declare class MDLTransform extends NSObject implements MDLTransformComponent, NSCopying {
	...
	rotationAtTime(time: number);

	rotationMatrixAtTime(time: number): simd_float4x4;

	scaleAtTime(time: number);
	...
	setRotationForTime(rotation,time: number): void;

	setScaleForTime(scale,time: number): void;

	setShearForTime(shear,time: number): void;

	setTranslationForTime(translation,time: number): void;

	shearAtTime(time: number);

	translationAtTime(time: number);
}
...
declare class MDLURLTexture extends MDLTexture {
	...
	static irradianceTextureCubeWithTextureNameDimensions(texture: MDLTexture, name: string, dimensions): MDLURLTexture; // inherited from MDLTexture

	static irradianceTextureCubeWithTextureNameDimensionsRoughness(texture: MDLTexture, name: string, dimensions,roughness: number): MDLURLTexture; // inherited from MDLTexture
...
declare class MDLVoxelArray extends MDLObject {
	...
	indexOfSpatialLocation(location);
	...
	setVoxelAtIndex(index): void;

	setVoxelsForMeshDivisionsPatchRadius(mesh: MDLMesh, divisions: number, patchRadius: number): void;

	spatialLocationOfIndex(index);

	unionWithVoxels(voxels: MDLVoxelArray): void;

	voxelBoundingBoxAtIndex(index): MDLAxisAlignedBoundingBox;

	voxelExistsAtIndexAllowAnyXAllowAnyYAllowAnyZAllowAnyShell(index,allowAnyX: boolean, allowAnyY: boolean, allowAnyZ: boolean, allowAnyShell: boolean): boolean;
