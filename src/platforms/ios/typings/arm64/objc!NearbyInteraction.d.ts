...
declare var NINearbyObjectDirectionNotAvailable;
...
interface NISessionDelegate extends NSObjectProtocol {
	...
	sessionDidRemoveNearbyObjectsWithReason?(session: NISession, nearbyObjects: NSArray<NINearbyObject>, reason: NINearbyObjectRemovalReason): void;

	sessionDidUpdateNearbyObjects?(session: NISession, nearbyObjects: NSArray<NINearbyObject>): void;
