...
declare function nw_privacy_context_create(description: string): NSObject;
...
declare function nw_quic_add_tls_application_protocol(options: NSObject, application_protocol: string): void;
...
declare function nw_quic_set_application_error(metadata: NSObject, application_error: number, reason: string): void;
