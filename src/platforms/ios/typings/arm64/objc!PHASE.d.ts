...
declare class PHASECardioidDirectivityModelParameters extends PHASEDirectivityModelParameters {
	...
	constructor(o: { subbandParameters: NSArray<PHASECardioidDirectivityModelSubbandParameters>; });

	initWithSubbandParameters(subbandParameters: NSArray<PHASECardioidDirectivityModelSubbandParameters>): this;
}
...
declare class PHASEConeDirectivityModelParameters extends PHASEDirectivityModelParameters {
	...
	constructor(o: { subbandParameters: NSArray<PHASEConeDirectivityModelSubbandParameters>; });

	initWithSubbandParameters(subbandParameters: NSArray<PHASEConeDirectivityModelSubbandParameters>): this;
}
...
declare class PHASEEnvelope extends NSObject {
	...
	constructor(o: { startPoint; segments: NSArray<PHASEEnvelopeSegment>; });

	evaluateForValue(x: number): number;

	initWithStartPointSegments(startPoint, segments: NSArray<PHASEEnvelopeSegment>): this;
}
...
declare class PHASEEnvelopeSegment extends NSObject {
	...
	constructor(o: { endPoint; curveType: PHASECurveType; });

	initWithEndPointCurveType(endPoint, curveType: PHASECurveType): this;
}
...
declare class PHASEOccluder extends PHASEObject {
	...
	initWithEngineShapes(engine: PHASEEngine, shapes: NSArray<PHASEShape>): this;
}
...
declare class PHASEShape extends NSObject implements NSCopying {
	...
	constructor(o: { engine: PHASEEngine; mesh: MDLMesh; materials: NSArray<PHASEMaterial>; });

	copyWithZone(zone: interop.Pointer | interop.Reference<any>): any;

	initWithEngineMesh(engine: PHASEEngine, mesh: MDLMesh): this;

	initWithEngineMeshMaterials(engine: PHASEEngine, mesh: MDLMesh, materials: NSArray<PHASEMaterial>): this;
}
