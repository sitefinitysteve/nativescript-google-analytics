...
interface PKAddSecureElementPassViewControllerDelegate extends NSObjectProtocol {
	...
	addSecureElementPassViewControllerDidFinishAddingSecureElementPassesError(controller: PKAddSecureElementPassViewController, passes: NSArray<PKSecureElementPass>, error: NSError): void;
}
...
declare class PKAddShareablePassConfiguration extends PKAddSecureElementPassConfiguration {
	...
	static configurationForPassMetadataProvisioningPolicyIdentifierPrimaryActionCompletion(passMetadata: NSArray<PKShareablePassMetadata>, provisioningPolicyIdentifier: string, action: PKAddShareablePassConfigurationPrimaryAction, completion: (p1: PKAddShareablePassConfiguration, p2: NSError) => void): void;
...
declare class PKIssuerProvisioningExtensionHandler extends NSObject {
	...
	generateAddPaymentPassRequestForPassEntryWithIdentifierConfigurationCertificateChainNonceNonceSignatureCompletionHandler(identifier: string, configuration: PKAddPaymentPassRequestConfiguration, certificates: NSArray<NSData>, nonce: NSData, nonceSignature: NSData, completion: (p1: PKAddPaymentPassRequest) => void): void;
...
declare class PKPaymentRequestPaymentMethodUpdate extends PKPaymentRequestUpdate {
	...
	constructor(o: { errors: NSArray<NSError>; paymentSummaryItems: NSArray<PKPaymentSummaryItem>; });

	initWithErrorsPaymentSummaryItems(errors: NSArray<NSError>, paymentSummaryItems: NSArray<PKPaymentSummaryItem>): this;
}
