...
declare class PKCanvasView extends UIScrollView implements PKToolPickerObserver {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): PKCanvasView; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): PKCanvasView; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): PKCanvasView; // inherited from UIAppearance
...
declare class PKDrawing extends NSObject implements NSCopying, NSSecureCoding {
	...
	constructor(o: { strokes: NSArray<PKStroke>; });
	...
	drawingByAppendingStrokes(strokes: NSArray<PKStroke>): PKDrawing;
	...
	initWithStrokes(strokes: NSArray<PKStroke>): this;
}
...
declare class PKStrokePath extends NSObject implements NSCopying {
	...
	constructor(o: { controlPoints: NSArray<PKStrokePoint>; creationDate: Date; });
	...
	initWithControlPointsCreationDate(controlPoints: NSArray<PKStrokePoint>, creationDate: Date): this;
