...
declare class PHPhotoLibrary extends NSObject {
	...
	cloudIdentifierMappingsForLocalIdentifiers(localIdentifiers: NSArray<string>): NSDictionary<string, PHCloudIdentifierMapping>;

	localIdentifierMappingsForCloudIdentifiers(cloudIdentifiers: NSArray<PHCloudIdentifier>): NSDictionary<PHCloudIdentifier, PHLocalIdentifierMapping>;
