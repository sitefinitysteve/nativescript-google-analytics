...
declare class SHCustomCatalog extends SHCatalog {
	...
	addReferenceSignatureRepresentingMediaItemsError(signature: SHSignature, mediaItems: NSArray<SHMediaItem>): boolean;
...
declare class SHMediaLibrary extends NSObject {
	...
	addMediaItemsCompletionHandler(mediaItems: NSArray<SHMediaItem>, completionHandler: (p1: NSError) => void): void;
}
