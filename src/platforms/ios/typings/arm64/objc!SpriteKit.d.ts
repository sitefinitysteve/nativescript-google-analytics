...
declare class SKAttributeValue extends NSObject implements NSSecureCoding {
	...
	static valueWithVectorFloat2(value); SKAttributeValue;

	static valueWithVectorFloat3(value); SKAttributeValue;

	static valueWithVectorFloat4(value); SKAttributeValue;
...
declare class SKFieldNode extends SKNode {
	...
	static linearGravityFieldWithVector(direction); SKFieldNode;
	...
	static velocityFieldWithVector(direction); SKFieldNode;
...
declare class SKUniform extends NSObject implements NSCopying, NSSecureCoding {
	...
	static uniformWithNameVectorFloat2(name: string, value); SKUniform;

	static uniformWithNameVectorFloat3(name: string, value); SKUniform;

	static uniformWithNameVectorFloat4(name: string, value); SKUniform;
	...
	constructor(o: { name: string; vectorFloat2 ; });

	constructor(o: { name: string; vectorFloat3; });

	constructor(o: { name: string; vectorFloat4; });
	...
	initWithNameVectorFloat2(name: string, value); this;

	initWithNameVectorFloat3(name: string, value); this;

	initWithNameVectorFloat4(name: string, value); this;
}
...
declare class SKWarpGeometryGrid extends SKWarpGeometry implements NSSecureCoding {
	...
	static gridWithColumnsRowsSourcePositionsDestPositions(cols: number, rows: number, sourcePositions: interop.Pointer | interop.Reference<>, destPositions: interop.Pointer | interop.Reference<>): SKWarpGeometryGrid;
	...
	constructor(o: { columns: number; rows: number; sourcePositions: interop.Pointer | interop.Reference<>; destPositions: interop.Pointer | interop.Reference<>; });

	destPositionAtIndex(index: number);

	encodeWithCoder(coder: NSCoder): void;

	gridByReplacingDestPositions(destPositions: interop.Pointer | interop.Reference<>): this;

	gridByReplacingSourcePositions(sourcePositions: interop.Pointer | interop.Reference<>): this;

	initWithCoder(coder: NSCoder): this;

	initWithColumnsRowsSourcePositionsDestPositions(cols: number, rows: number, sourcePositions: interop.Pointer | interop.Reference<>, destPositions: interop.Pointer | interop.Reference<>): this;

	sourcePositionAtIndex(index: number);
}
