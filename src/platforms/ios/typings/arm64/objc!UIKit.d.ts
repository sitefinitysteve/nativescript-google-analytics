...
declare class NSDiffableDataSourceSectionSnapshot<ItemIdentifierType> extends NSObject implements NSCopying {
	...
	appendItems(items: NSArray<ItemIdentifierType>): void;

	appendItemsIntoParentItem(items: NSArray<ItemIdentifierType>, parentItem: ItemIdentifierType): void;

	collapseItems(items: NSArray<ItemIdentifierType>): void;
	...
	deleteItems(items: NSArray<ItemIdentifierType>): void;

	expandItems(items: NSArray<ItemIdentifierType>): void;

	expandedItems(): NSArray<ItemIdentifierType>;

	indexOfItem(item: ItemIdentifierType): number;

	insertItemsAfterItem(items: NSArray<ItemIdentifierType>, afterIdentifier: ItemIdentifierType): void;

	insertItemsBeforeItem(items: NSArray<ItemIdentifierType>, beforeIdentifier: ItemIdentifierType): void;
...
declare class NSDiffableDataSourceSnapshot<SectionIdentifierType, ItemIdentifierType> extends NSObject implements NSCopying {
	...
	appendItemsWithIdentifiers(identifiers: NSArray<ItemIdentifierType>): void;

	appendItemsWithIdentifiersIntoSectionWithIdentifier(identifiers: NSArray<ItemIdentifierType>, sectionIdentifier: SectionIdentifierType): void;

	appendSectionsWithIdentifiers(sectionIdentifiers: NSArray<any>): void;

	copyWithZone(zone: interop.Pointer | interop.Reference<any>): any;

	deleteAllItems(): void;

	deleteItemsWithIdentifiers(identifiers: NSArray<ItemIdentifierType>): void;

	deleteSectionsWithIdentifiers(sectionIdentifiers: NSArray<SectionIdentifierType>): void;
	...
	insertItemsWithIdentifiersAfterItemWithIdentifier(identifiers: NSArray<ItemIdentifierType>, itemIdentifier: ItemIdentifierType): void;

	insertItemsWithIdentifiersBeforeItemWithIdentifier(identifiers: NSArray<ItemIdentifierType>, itemIdentifier: ItemIdentifierType): void;

	insertSectionsWithIdentifiersAfterSectionWithIdentifier(sectionIdentifiers: NSArray<SectionIdentifierType>, toSectionIdentifier: SectionIdentifierType): void;

	insertSectionsWithIdentifiersBeforeSectionWithIdentifier(sectionIdentifiers: NSArray<SectionIdentifierType>, toSectionIdentifier: SectionIdentifierType): void;
	...
	reconfigureItemsWithIdentifiers(identifiers: NSArray<ItemIdentifierType>): void;

	reloadItemsWithIdentifiers(identifiers: NSArray<ItemIdentifierType>): void;

	reloadSectionsWithIdentifiers(sectionIdentifiers: NSArray<SectionIdentifierType>): void;
...
declare class NSTextContentManager extends NSObject implements NSSecureCoding, NSTextElementProvider {
	...
	replaceContentsInRangeWithTextElements(range: NSTextRange, textElements: NSArray<NSTextElement>): void;
...
declare class NSTextSelection extends NSObject implements NSSecureCoding {
	...
	constructor(o: { ranges: NSArray<NSTextRange>; affinity: NSTextSelectionAffinity; granularity: NSTextSelectionGranularity; });
	...
	initWithRangesAffinityGranularity(textRanges: NSArray<NSTextRange>, affinity: NSTextSelectionAffinity, granularity: NSTextSelectionGranularity): this;

	textSelectionWithTextRanges(textRanges: NSArray<NSTextRange>): NSTextSelection;
}
...
declare class NSTextSelectionNavigation extends NSObject {
	...
	textSelectionsInteractingAtPointInContainerAtLocationAnchorsModifiersSelectingBounds(point: CGPoint, containerLocation: NSTextLocation, anchors: NSArray<NSTextSelection>, modifiers: NSTextSelectionNavigationModifier, selecting: boolean, bounds: CGRect): NSArray<NSTextSelection>;
}
...
declare class UIActivityItemsConfiguration extends NSObject implements UIActivityItemsConfigurationReading {
	...
	static activityItemsConfigurationWithItemProviders(itemProviders: NSArray<NSItemProvider>): UIActivityItemsConfiguration;

	static activityItemsConfigurationWithObjects(objects: NSArray<NSItemProviderWriting>): UIActivityItemsConfiguration;
	...
	constructor(o: { itemProviders: NSArray<NSItemProvider>; });

	constructor(o: { objects: NSArray<NSItemProviderWriting>; });
	...
	initWithItemProviders(itemProviders: NSArray<NSItemProvider>): this;

	initWithObjects(objects: NSArray<NSItemProviderWriting>): this;
...
declare class UICollectionView extends UIScrollView implements UIDataSourceTranslating, UISpringLoadedInteractionSupporting {
	...
	reconfigureItemsAtIndexPaths(indexPaths: NSArray<NSIndexPath>): void;
...
declare class UICollectionViewListCell extends UICollectionViewCell {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): UICollectionViewListCell; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): UICollectionViewListCell; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): UICollectionViewListCell; // inherited from UIAppearance
...
declare class UIColorWell extends UIControl {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): UIColorWell; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): UIColorWell; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): UIColorWell; // inherited from UIAppearance
...
declare class UICommand extends UIMenuElement {
	...
	static commandWithTitleImageActionPropertyListAlternates(title: string, image: UIImage, action: string, propertyList: any, alternates: NSArray<UICommandAlternate>): UICommand;
...
declare class UIDocumentBrowserViewController extends UIViewController implements NSCoding {
	...
	constructor(o: { forOpeningContentTypes: NSArray<UTType>; });
	...
	initForOpeningContentTypes(contentTypes: NSArray<UTType>): this;
...
interface UIDocumentBrowserViewControllerDelegate extends NSObjectProtocol {
	...
	documentBrowserDidPickDocumentsAtURLs?(controller: UIDocumentBrowserViewController, documentURLs: NSArray<NSURL>): void;
...
declare class UIDocumentPickerViewController extends UIViewController {
	...
	constructor(o: { forExportingURLs: NSArray<NSURL>; });

	constructor(o: { forExportingURLs: NSArray<NSURL>; asCopy: boolean; });

	constructor(o: { forOpeningContentTypes: NSArray<UTType>; });

	constructor(o: { forOpeningContentTypes: NSArray<UTType>; asCopy: boolean; });
	...
	initForExportingURLs(urls: NSArray<NSURL>): this;

	initForExportingURLsAsCopy(urls: NSArray<NSURL>, asCopy: boolean): this;

	initForOpeningContentTypes(contentTypes: NSArray<UTType>): this;

	initForOpeningContentTypesAsCopy(contentTypes: NSArray<UTType>, asCopy: boolean): this;
...
declare class UIEventAttributionView extends UIView {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): UIEventAttributionView; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): UIEventAttributionView; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): UIEventAttributionView; // inherited from UIAppearance
...
declare class UIFocusDebugger extends NSObject {
	...
	static checkFocusGroupTreeForEnvironment(environment: UIFocusEnvironment): string;
...
declare class UIFontPickerViewControllerConfiguration extends NSObject implements NSCopying {
	...
	static filterPredicateForFilteredLanguages(filteredLanguages: NSArray<string>): NSPredicate;
...
declare class UIImageSymbolConfiguration extends UIImageConfiguration {
	...
	static configurationWithPaletteColors(paletteColors: NSArray<UIColor>): UIImageSymbolConfiguration;
...
declare class UIKeyCommand extends UICommand {
	...
	static commandWithTitleImageActionInputModifierFlagsPropertyListAlternates(title: string, image: UIImage, action: string, input: string, modifierFlags: UIKeyModifierFlags, propertyList: any, alternates: NSArray<UICommandAlternate>): UIKeyCommand;
...
declare class UIListContentView extends UIView implements UIContentView {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): UIListContentView; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): UIListContentView; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): UIListContentView; // inherited from UIAppearance
...
declare class UIMenu extends UIMenuElement {
	...
	static menuWithChildren(children: NSArray<UIMenuElement>): UIMenu;

	static menuWithTitleChildren(title: string, children: NSArray<UIMenuElement>): UIMenu;

	static menuWithTitleImageIdentifierOptionsChildren(title: string, image: UIImage, identifier: string, options: UIMenuOptions, children: NSArray<UIMenuElement>): UIMenu;
	...
	menuByReplacingChildren(newChildren: NSArray<UIMenuElement>): UIMenu;
}
...
declare class UISearchTextField extends UITextField {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): UISearchTextField; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): UISearchTextField; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): UISearchTextField; // inherited from UIAppearance
...
declare class UISegmentedControl extends UIControl implements NSCoding, UISpringLoadedInteractionSupporting {
	...
	constructor(o: { frame: CGRect; actions: NSArray<UIAction>; });
	...
	initWithFrameActions(frame: CGRect, actions: NSArray<UIAction>): this;
...
declare class UITableView extends UIScrollView implements NSCoding, UIDataSourceTranslating, UISpringLoadedInteractionSupporting {
	...
	reconfigureRowsAtIndexPaths(indexPaths: NSArray<NSIndexPath>): void;
...
declare class UITextField extends UIControl implements NSCoding, UIContentSizeCategoryAdjusting, UITextDraggable, UITextDroppable, UITextInput, UITextPasteConfigurationSupporting {
	...
	insertTextAlternativesStyle(text: string, alternatives: NSArray<string>, style: UITextAlternativeStyle): void;
...
declare class UITrackingLayoutGuide extends UILayoutGuide {
	...
	setConstraintsActiveWhenAwayFromEdge(trackingConstraints: NSArray<NSLayoutConstraint>, edge: NSDirectionalRectEdge): void;

	setConstraintsActiveWhenNearEdge(trackingConstraints: NSArray<NSLayoutConstraint>, edge: NSDirectionalRectEdge): void;
}
...
declare var UIViewControllerRestoration: {
	...
	viewControllerWithRestorationIdentifierPathCoder(identifierComponents: NSArray<string>, coder: NSCoder): UIViewController;
};
