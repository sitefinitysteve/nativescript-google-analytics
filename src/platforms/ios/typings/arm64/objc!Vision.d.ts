...
declare class VNContour extends NSObject implements NSCopying, VNRequestRevisionProviding {
	...
	readonly normalizedPoints: interop.Pointer | interop.Reference<>;
...
declare class VNGeometryUtils extends NSObject {
	...
	static boundingCircleForPointsError(points: NSArray<VNPoint>): VNCircle;

	static boundingCircleForSIMDPointsPointCountError(points: interop.Pointer | interop.Reference<>, pointCount: number): VNCircle;
...
declare function VNImagePointForFaceLandmarkPoint(faceLandmarkPoint , faceBoundingBox: CGRect, imageWidth: number, imageHeight: number): CGPoint;
...
declare function VNNormalizedFaceBoundingBoxPointForLandmarkPoint(faceLandmarkPoint , faceBoundingBox: CGRect, imageWidth: number, imageHeight: number): CGPoint;
...
declare class VNSequenceRequestHandler extends NSObject {
	...
	performRequestsOnCMSampleBufferError(requests: NSArray<VNRequest>, sampleBuffer: any): boolean;

	performRequestsOnCMSampleBufferOrientationError(requests: NSArray<VNRequest>, sampleBuffer: any, orientation: CGImagePropertyOrientation): boolean;
