...
declare function _os_trace_with_buffer(dso: interop.Pointer | interop.Reference<any>, message: string, type: number, buffer: interop.Pointer | interop.Reference<any>, buffer_size: number, payload: (p1: interop.Pointer | interop.Reference<any>) => void): void;
